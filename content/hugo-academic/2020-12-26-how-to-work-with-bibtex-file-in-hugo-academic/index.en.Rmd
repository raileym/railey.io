...
To start, you need a bibliographical file. I am using a [BibTeX](http://www.bibtex.org/Format/)-formatted file to organize the information for my bibliography. And for the sake of convenience, I am using [Mendeley Desktop](https://www.mendeley.com/download-desktop-new/) to manage my bibliographic data, including generating updated versions of my bibtex file, as necessary.

I am keeping my BibTeX (.bib) file in my <strong>/static</strong> directory under a <strong>bib</strong> directory,
