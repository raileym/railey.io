...
- this expression is a **quadratic** since the term with the highest degree is a squared term, such as $x^2$ or $y^2$; and,
...
For this example, I am going to give this problem type a name, "The Binomial." I find giving a name to a problem type or equation helps me this expression from others. I plan to name everything AND I plan to count everything.

For "The Binomial", I record its name, shape, and steps to factor.
