...
for m in m_list:
    CTNS_MAKE(target=m)
    CTNS_BUILD(target=m, id=m[0], encrypt=False, version=VERSION, image_target=m[0], opt_ctns = [ 
        "slide"
      , "dynamic"
...
```{python, eval=TRUE, results="asis", echo=FALSE, warning=FALSE, message=FALSE}
m_list = [
     ['abs_value_1_qa, abs_value_2_qa, abs_value_2b_qa, abs_value_2c_qa, abs_value_3_qa']
]
...
the definition of absolute value for negative numbers,
