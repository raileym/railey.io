...
tags: []
subtitle: ''
summary: 'After three weeks of attending my first course at the University of Texas at Austin, I decided I was not prepared for success and chose to drop the course rather than score poorly and suffer from anxiety all the while.'
authors: []
...
Still, it is **my mistake** for not asking for the required textbook's name for my course. Despite my error, I completely understand why the professors chose their desired text. Their selected text is well-received in the community and covers an important topic directly inline with data science and machine learning -- I agree with the professor's choice.
...
When I arrive, I realize the tri-camp focus is on swimming, not on running.  As I get off the bus upon arrival, I see everyone has brought their swim gear, and no one has brought any running gear. My camp counselor hands me the first-time printed tri-camp brochure: "Tri-Camp USA - Winning in Swimming." Oh no, did I sign up for the wrong (tri-camp) camp?
