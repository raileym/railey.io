...
print("$\\renewcommand{\\qedsymbol}{\\rule{0.5em}{0.5em}}$")
    ...
    for n in range(h):
        ...
        for m in range(n+1):
            ...
            if tuple([n,m]) in symbol:
                ...
                if "TRUE" == combo:   
                    val = "{ \\fcolorbox{black}{brightblue}{${%d \\choose %d}$} }" % (n,m)
                else:
                    val = "{ \\fcolorbox{black}{brightblue}{%d} }" % choose(n,m)

            elif tuple([n,m,'green']) in highlight:
                if "TRUE" == combo:   
                    val = "{ \\fcolorbox{black}{brightgreen}{${%d \\choose %d}$} }" % (n,m)
                else:
                ...
                val = "{ \\fcolorbox{transparent}{transparent}{${%d \\choose %d}$} }" % (n,m)
