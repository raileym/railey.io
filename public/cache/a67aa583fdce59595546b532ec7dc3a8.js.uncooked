  ...
  CTNS.QUIZ_SET["a67aa583fdce59595546b532ec7dc3a8"] = function (PYTHON_ID) {
     ...
     CTNS.QUESTIONS[CTNS_ID] = [
{
    ...
    frontSpeak: " A set is a field if ...     ",
    backSpeak: " A set is a  field  if it satisfies all 12 field axioms.     ",
