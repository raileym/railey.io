  ...
  CTNS.QUIZ_SET["d758129083a3eef4ef7c1147a9988916"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '2186', 1);
    ...
    */
	...
	jQuery(".slide_2186").each( function() {do_center(this)} );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_2186_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_2186_SlideNo_0
	What do these buy me? tag=, masterid=2186, slideno=SlideNo_0
	'scriptblock_2186_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_2186_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_2186_SlideNo_0'] = NUMBERS.symbols['scriptblock_2186_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_2186_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_42208 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_42208 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_73263 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointbT, window[PMGRAPHICID].pointbB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_73263 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointbT, window[PMGRAPHICID].pointbB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
	...
	strokeWidth: 4} );
         ...
         */
        window[PMGRAPHICID].graph54093 = window[PMGRAPHICID].board.create('functiongraph', 
