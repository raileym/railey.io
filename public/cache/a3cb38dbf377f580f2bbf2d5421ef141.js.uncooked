  ...
  CTNS.QUIZ_SET["a3cb38dbf377f580f2bbf2d5421ef141"] = function (PYTHON_ID) {
     ...
     CTNS.QUESTIONS[CTNS_ID] = [
{
    ...
    frontSpeak: " Field Axioms<br><br>Associativity Under Addition     ",
    backSpeak: " Addition is associative for a set F if (x+y)+z = x+(y+z) for values x-y-and-z in set F.     ",
