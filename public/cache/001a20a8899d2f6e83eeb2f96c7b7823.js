  ...
  CTNS.QUIZ_SET["001a20a8899d2f6e83eeb2f96c7b7823"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '3382', 1);
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_3382_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_3382_SlideNo_0
	What do these buy me? tag=, masterid=3382, slideno=SlideNo_0
	'scriptblock_3382_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_3382_SlideNo_0';
 ...
 */
window[PMGRAPHICID].segment_56643 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_56643 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
	...
	strokeWidth: 4} );
         ...
         */
        window[PMGRAPHICID].graph10074 = window[PMGRAPHICID].board.create('functiongraph', 
