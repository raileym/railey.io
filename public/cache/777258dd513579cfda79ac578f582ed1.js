  ...
  CTNS.QUIZ_SET["777258dd513579cfda79ac578f582ed1"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '1863', 1);
    ...
    */
	...
	jQuery(".slide_1863").each( function() {do_center(this)} );
 ...
 * quiz container.
 */
CTNS.NUMBERS.GID = 'quiz_1863';
CTNS.NUMBERS.equations['quiz_1863'] = [];
CTNS.NUMBERS.symbols['quiz_1863'] = CTNS.NUMBERS.symbols['quiz_1863'] || {};

/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_1863_SlideNo_0'] = CTNS.NUMBERS.symbols['new_scriptblock_1863_SlideNo_0'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_1863'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_1863_SlideNo_0',                ablock           = '#answerblock_1863_SlideNo_0',                acblock          = '#answercommentaryblock_1863_SlideNo_0',                                grblock          = 'graphicblock_1863_SlideNo_0',                grblock_Q        = 'graphicblock_Q_1863_SlideNo_0',                grblock_A        = 'graphicblock_A_1863_SlideNo_0',                grblock_B        = 'graphicblock_B_1863_SlideNo_0',                grblock_C        = 'graphicblock_C_1863_SlideNo_0',                grblock_D        = 'graphicblock_D_1863_SlideNo_0',                                grblock_f        = (typeof tml_1863_SlideNo_0   !== 'undefined') ? tml_1863_SlideNo_0   : null,                grblock_Q_f      = (typeof tml_Q_1863_SlideNo_0 !== 'undefined') ? tml_Q_1863_SlideNo_0 : null,                grblock_A_f      = (typeof tml_A_1863_SlideNo_0 !== 'undefined') ? tml_A_1863_SlideNo_0 : null,                grblock_B_f      = (typeof tml_B_1863_SlideNo_0 !== 'undefined') ? tml_B_1863_SlideNo_0 : null,                grblock_C_f      = (typeof tml_C_1863_SlideNo_0 !== 'undefined') ? tml_C_1863_SlideNo_0 : null,                grblock_D_f      = (typeof tml_D_1863_SlideNo_0 !== 'undefined') ? tml_D_1863_SlideNo_0 : null,                numbers          = NUMBERS,                gid              = 'quiz_1863',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_1863_SlideNo_0'],                gsymbols         = NUMBERS.symbols['quiz_1863'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];                 do {             symbols.x1 = [-4, -3, -2, -1].ctns_rand();             symbols.y1 = [-4, -3, -2, -1, 1, 2, 3, 4].ctns_rand();             symbols.x2 = [1, 2, 3, 4].ctns_rand();             symbols.y2 = [-4, -3, -2, -1, 1, 2, 3, 4].ctns_rand();         } while( symbols.x1 == symbols.x2 || symbols.y1 == symbols.y2 || is_lt(symbols.y1, symbols.y2) || is_pos(symbols.x1) || is_neg(symbols.x2));          symbols.m = (symbols.y2-symbols.y1)/(symbols.x2-symbols.x1);         symbols.b = symbols.y1 - symbols.x1*symbols.m;          symbols.m_ = d2f( symbols.m );         symbols.b_ = d2f( symbols.b );          symbols.p_x1 = addparen( symbols.x1);         symbols.p_y1 = addparen( symbols.y1);          symbols.EQ = 'y= %s x + %s'.ctns_format([symbols.m_, symbols.b_]).ctns_equation();          q.push(' Consider a line with slope-intercept form $| ${EQ} |$ that connects the two points $$a$$ and $$b$$, <br/><br/> $$ (${x1}, ${y1}) $$ and $$ (${x2}, ${y2}).$$ <br/><br/> The <strong>slope of this line</strong> equals the ratio $$\\frac{\\Delta y}{\\Delta x}$$,<br/><br/> $$\\frac{\\Delta y}{\\Delta x} = \\frac{y_2-y_1}{x_2-x_1} = \\frac{${y2}-${p_y1}}{${x2}-${p_x1}} = ${m_}$$, <br/><br/> where $$(x_1,y_1)$$ corresponds to $$ (${x1}, ${y1}) $$, and <br/>$$(x_2,y_2)$$ corresponds to $$ (${x2}, ${y2}).$$ ');          $(qblock).html(tex({'symbols':symbols}, q.join(' ')));         $(ablock).html(tex({'symbols':symbols}, q.join(' ')));                  [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_Q_1863_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_Q_1863_SlideNo_0
	What do these buy me? tag=Q_, masterid=1863, slideno=SlideNo_0
	'scriptblock_1863_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_Q_1863_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_1863_SlideNo_0'] = NUMBERS.symbols['scriptblock_1863_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_1863_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_19444 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointp, window[PMGRAPHICID].pointq] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'blue',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_19444 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointp, window[PMGRAPHICID].pointq] , { 
	visible:true,
	straightFirst: true, 
	straightLast: true, 
	strokeColor:'blue',
...
window[PMGRAPHICID].startArrow_31820 = window[PMGRAPHICID].pointr;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_31820 = window[PMGRAPHICID].board.create('point', 
	[ 
	...
	{visible:false});
window[PMGRAPHICID].arrow_31820 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_31820, window[PMGRAPHICID].endArrow_31820], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_A_1863_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_A_1863_SlideNo_0
	What do these buy me? tag=A_, masterid=1863, slideno=SlideNo_0
	'scriptblock_1863_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_A_1863_SlideNo_0';
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_3511 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointp, window[PMGRAPHICID].pointq] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_3511 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointp, window[PMGRAPHICID].pointq] , { 
	visible:true,
	straightFirst: true, 
	straightLast: true, 
	strokeColor:'red',
...
window[PMGRAPHICID].startArrow_68456 = window[PMGRAPHICID].pointr;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_68456 = window[PMGRAPHICID].board.create('point', 
	[ 
	function() { var check = window[PMGRAPHICID].pointb.X()-window[PMGRAPHICID].pointr.X(); if (check == 0) return window[PMGRAPHICID].pointb.X(); return (check > 0 ) ? window[PMGRAPHICID].pointb.X()-0.3 : window[PMGRAPHICID].pointb.X()+0.3;}, 
	function() { var check = window[PMGRAPHICID].pointb.Y()-window[PMGRAPHICID].pointr.Y(); if (check == 0) return window[PMGRAPHICID].pointb.Y(); return (check > 0 ) ? window[PMGRAPHICID].pointb.Y()-0.3 : window[PMGRAPHICID].pointb.Y()+0.3;}, 
	], 
	{visible:false});
window[PMGRAPHICID].arrow_68456 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_68456, window[PMGRAPHICID].endArrow_68456], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
...
window[PMGRAPHICID].text90992 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointr.X()+-1; }, 
	...
	{ cssClass:'window[PMGRAPHICID].text90992 center', cssStyle:'' , fontSize:'18' , strokeColor:'black' } );
 
window[PMGRAPHICID].text63314 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointr.X()+1; }, 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text63314 center', 
	  cssClass:'window[PMGRAPHICID].text63314 center', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text27631 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointr.X()+1; }, 
		function() { return window[PMGRAPHICID].pointr.Y()+-0.5; }, 
		function() { 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text27631 center', 
	  cssClass:'window[PMGRAPHICID].text27631 center', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
