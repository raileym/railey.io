  ...
  CTNS.QUIZ_SET["14b8213a87867990c0f3b58cbd46f45e"] = function (PYTHON_ID) {
     ...
     CTNS.QUESTIONS[CTNS_ID] = [
{
    ...
    frontSpeak: " Multiplicative inverse of x     ",
    backSpeak: " The multiplicative inverse of x is one over xx times one over x equals one.     ",
