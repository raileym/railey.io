  ...
  CTNS.QUIZ_SET["648c9c54bfef97a3aef9320c3eab4700"] = function () {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '3038', 1);
    ...
    */
	...
	jQuery(".slide_3038").each( function() {do_center(this)} );
 ...
 * quiz container.
 */
CTNS.NUMBERS.GID = 'quiz_3038';
CTNS.NUMBERS.equations['quiz_3038'] = [];
CTNS.NUMBERS.symbols['quiz_3038'] = CTNS.NUMBERS.symbols['quiz_3038'] || {};

/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_3038_SlideNo_0'] = CTNS.NUMBERS.symbols['new_scriptblock_3038_SlideNo_0'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_3038'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_3038_SlideNo_0',                ablock           = '#answerblock_3038_SlideNo_0',                acblock          = '#answercommentaryblock_3038_SlideNo_0',                                rightblock       = '#rightblock_3038_SlideNo_0',                wrongblock       = '#wrongblock_3038_SlideNo_0',                undecidedblock   = '#undecidedblock_3038_SlideNo_0',                speech_F         = ($('#speech_F_3038_SlideNo_0').length == 0) ? null : $('#speech_F_3038_SlideNo_0').html(),                speech_B         = ($('#speech_B_3038_SlideNo_0').length == 0) ? null : $('#speech_B_3038_SlideNo_0').html(),                speech_1         = ($('#speech_1_3038_SlideNo_0').length == 0) ? null : $('#speech_1_3038_SlideNo_0').html(),                speech_2         = ($('#speech_2_3038_SlideNo_0').length == 0) ? null : $('#speech_2_3038_SlideNo_0').html(),                speech_3         = ($('#speech_3_3038_SlideNo_0').length == 0) ? null : $('#speech_3_3038_SlideNo_0').html(),                speech_4         = ($('#speech_4_3038_SlideNo_0').length == 0) ? null : $('#speech_4_3038_SlideNo_0').html(),                speech_5         = ($('#speech_5_3038_SlideNo_0').length == 0) ? null : $('#speech_5_3038_SlideNo_0').html(),                gr3dblock        = 'graphic3dblock_3038_SlideNo_0',                gr3dblock_A      = 'graphic3dblock_A_3038_SlideNo_0',                gr3dblock_B      = 'graphic3dblock_B_3038_SlideNo_0',                gr3dblock_C      = 'graphic3dblock_C_3038_SlideNo_0',                gr3dblock_D      = 'graphic3dblock_D_3038_SlideNo_0',                gr3dblock_E      = 'graphic3dblock_E_3038_SlideNo_0',                gr3dblock_F      = 'graphic3dblock_F_3038_SlideNo_0',                gr3dblock_1      = 'graphic3dblock_1_3038_SlideNo_0',                gr3dblock_2      = 'graphic3dblock_2_3038_SlideNo_0',                gr3dblock_3      = 'graphic3dblock_3_3038_SlideNo_0',                gr3dblock_4      = 'graphic3dblock_4_3038_SlideNo_0',                gr3dblock_5      = 'graphic3dblock_5_3038_SlideNo_0',                gr3dblock_6      = 'graphic3dblock_6_3038_SlideNo_0',                gr3dblock_7      = 'graphic3dblock_7_3038_SlideNo_0',                gr3dblock_8      = 'graphic3dblock_8_3038_SlideNo_0',                gr3dblock_9      = 'graphic3dblock_9_3038_SlideNo_0',                grblock          = 'graphicblock_3038_SlideNo_0',                grblock_Q        = 'graphicblock_Q_3038_SlideNo_0',                grblock_A        = 'graphicblock_A_3038_SlideNo_0',                grblock_B        = 'graphicblock_B_3038_SlideNo_0',                grblock_C        = 'graphicblock_C_3038_SlideNo_0',                grblock_D        = 'graphicblock_D_3038_SlideNo_0',                grblock_E        = 'graphicblock_E_3038_SlideNo_0',                grblock_F        = 'graphicblock_F_3038_SlideNo_0',                                grblock_f        = (typeof tml_3038_SlideNo_0   !== 'undefined') ? tml_3038_SlideNo_0   : null,                grblock_Q_f      = (typeof tml_Q_3038_SlideNo_0 !== 'undefined') ? tml_Q_3038_SlideNo_0 : null,                grblock_A_f      = (typeof tml_A_3038_SlideNo_0 !== 'undefined') ? tml_A_3038_SlideNo_0 : null,                grblock_B_f      = (typeof tml_B_3038_SlideNo_0 !== 'undefined') ? tml_B_3038_SlideNo_0 : null,                grblock_C_f      = (typeof tml_C_3038_SlideNo_0 !== 'undefined') ? tml_C_3038_SlideNo_0 : null,                grblock_D_f      = (typeof tml_D_3038_SlideNo_0 !== 'undefined') ? tml_D_3038_SlideNo_0 : null,                grblock_E_f      = (typeof tml_E_3038_SlideNo_0 !== 'undefined') ? tml_E_3038_SlideNo_0 : null,                grblock_F_f      = (typeof tml_F_3038_SlideNo_0 !== 'undefined') ? tml_F_3038_SlideNo_0 : null,                numbers          = NUMBERS,                gid              = 'quiz_3038',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_3038_SlideNo_0'],                gsymbols         = NUMBERS.symbols['quiz_3038'],                 audio            = PROBLEMS.audio_remote_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];                 /* I am toggling between quadrants so that my lines have more          * of a slant to them. Remember, this graph is meant to be           * instructional.          */         if ( [0, 1].ctns_rand() ) {              /* Go positive */             do {                 symbols.xHigh = [4, 3, 2, 1].ctns_rand();                 symbols.yHigh = [-4, -3, -2, -1, 1, 2, 3, 4].ctns_rand();                 symbols.xLow = [-1, -2, -3, -4].ctns_rand();                 symbols.yLow = [-4, -3, -2, -1, 1, 2, 3, 4].ctns_rand();                 symbols.xSide = symbols.xHigh + 1;                 symbols.ySide = (symbols.yHigh+symbols.yLow)/2;                 symbols.xBase = (symbols.xHigh+symbols.xLow)/2;                 symbols.yBase = symbols.yLow - 0.75;                 symbols.xHighCoord = symbols.xHigh + 0.5;                 symbols.yHighCoord = symbols.yHigh - 1.5;                 symbols.xLowCoord = symbols.xLow + 0.5;                 symbols.yLowCoord = symbols.yLow - 1.5;             } while( symbols.xHigh == symbols.xLow || symbols.yHigh == symbols.yLow || is_lt(symbols.yHigh, symbols.yLow) );          } else {              /* Go negative */             do {                 symbols.xHigh = [-4, -3, -2, -1].ctns_rand();                 symbols.yHigh = [-4, -3, -2, -1, 1, 2, 3, 4].ctns_rand();                 symbols.xLow = [1, 2, 3, 4].ctns_rand();                 symbols.yLow = [-4, -3, -2, -1, 1, 2, 3, 4].ctns_rand();                 symbols.xSide = symbols.xHigh - 1.2;                 symbols.ySide = (symbols.yHigh+symbols.yLow)/2;                 symbols.xBase = (symbols.xHigh+symbols.xLow)/2;                 symbols.yBase = symbols.yLow - 0.75;                 symbols.xHighCoord = symbols.xHigh + 0.5;                 symbols.yHighCoord = symbols.yHigh + 1.5;                 symbols.xLowCoord = symbols.xLow + 0.5;                 symbols.yLowCoord = symbols.yLow + 1.5;             } while( symbols.xHigh == symbols.xLow || symbols.yHigh == symbols.yLow || is_lt(symbols.yHigh, symbols.yLow) );          }          symbols.RISE = symbols.yHigh - symbols.yLow;         symbols.RUN  = symbols.xHigh - symbols.xLow;         symbols.m_   = d2f(symbols.RISE / symbols.RUN);           symbols.xLow_ = addparen( symbols.xLow);         symbols.yLow_ = addparen( symbols.yLow);                          q.push(' $|  \\textrm{Slope} = ${m_} |$ ');           q.push( graphicblock( {"dim":"6", "gid":grblock}) );          q.push(' $|  \\begin{aligned} \\textrm{Slope} &= \\frac{\\Delta y}{\\Delta x} = \\frac{y_2-y_1}{x_2-x_1} \\\\[2ex]       &= \\frac{${yHigh} - ${yLow_}}{${xHigh} - ${xLow_}} \\\\[2ex]       &= ${m_},  \\end{aligned} |$ where $$ (x_2, y_2) $$ corresponds to $$( ${xHigh}, ${yHigh} )$$ and       $$ (x_1, y_1) $$ corresponds to $$( ${xLow}, ${yLow} )$$. ');      $(qblock).html(tex({"symbols":symbols}, q.join(' ')));                                  [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f,             grblock_E_f,             grblock_F_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D,             grblock_E,             grblock_F].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_3038_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_3038_SlideNo_0
	What do these buy me? tag=, masterid=3038, slideno=SlideNo_0
	'scriptblock_3038_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_3038_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_3038_SlideNo_0'] = NUMBERS.symbols['scriptblock_3038_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_3038_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_78175 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointbottom, window[PMGRAPHICID].pointtop] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'black',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_78175 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointbottom, window[PMGRAPHICID].pointtop] , { 
	visible:true,
	straightFirst: true, 
	straightLast: true, 
	strokeColor:'black',
...
window[PMGRAPHICID].text98142 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
	  ...
	  highlightCssClass:'window[PMGRAPHICID].text98142 center', 
	  cssClass:'window[PMGRAPHICID].text98142 center', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text7099 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text7099 center', 
	  cssClass:'window[PMGRAPHICID].text7099 center', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
