  ...
  CTNS.QUIZ_SET["93082b656555f5f43519727dc51df76d"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '3437', 1);
    ...
    */
	...
	jQuery(".slide_3437").each( function() {do_center(this)} );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_3437_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_3437_SlideNo_0
	What do these buy me? tag=, masterid=3437, slideno=SlideNo_0
	'scriptblock_3437_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_3437_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_3437_SlideNo_0'] = NUMBERS.symbols['scriptblock_3437_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_3437_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_23566 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointtop, window[PMGRAPHICID].pointbottom] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_23566 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointtop, window[PMGRAPHICID].pointbottom] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
	...
	strokeWidth: 4} );
         ...
         */
        window[PMGRAPHICID].graph98223 = window[PMGRAPHICID].board.create('functiongraph', 
