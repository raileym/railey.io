  ...
  CTNS.QUIZ_SET["c8e16dd7e7a8a91b0e31063ea1a9903c"] = function (PYTHON_ID) {
     ...
     CTNS.QUESTIONS[CTNS_ID] = [
{
    ...
    frontSpeak: " Field Axioms<br><br>Additive Inverse     ",
    backSpeak: " For a set $$\mathbb{F}$$ and all $$x \in \mathbb{F},$$ <br><br>there is an element $$-x \in \mathbb{F}$$ such that<br> $$x + (-x) = 0.$$     ",
