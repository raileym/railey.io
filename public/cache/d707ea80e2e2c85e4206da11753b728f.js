  ...
  CTNS.QUIZ_SET["d707ea80e2e2c85e4206da11753b728f"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '4196', 1);
    ...
    */
	...
	jQuery(".slide_4196").each( function() {do_center(this)} );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_4196_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_4196_SlideNo_0
	What do these buy me? tag=, masterid=4196, slideno=SlideNo_0
	'scriptblock_4196_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_4196_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_4196_SlideNo_0'] = NUMBERS.symbols['scriptblock_4196_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_4196_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_35040 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointT, window[PMGRAPHICID].pointB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_35040 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointT, window[PMGRAPHICID].pointB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
...
jQuery('button#button'+PMGRAPHICID+'start').click(function(event) {
    ...
    window[PMGRAPHICID].pointz.moveTo([x,y],1000);
         ...
         */
        window[PMGRAPHICID].graph56619 = window[PMGRAPHICID].board.create('functiongraph', 
