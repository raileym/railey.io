  ...
  CTNS.QUIZ_SET["e59abd9b982474f080c5424b57563f4b"] = function (PYTHON_ID) {
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_368170338 (CTNS, NUMBERS, GID, SCRIPTBLOCK_ID, FACTORY_ID, GRAPHICBLOCK_ID) {
...
window[PMGRAPHICID].text36897 = window[PMGRAPHICID].panel.create('text', 
        [ 
			-4,7 , 
			function() { 
		...
		{ anchorX:'middle', 
		  ...
		  highlightCssClass:'window[PMGRAPHICID].text36897 pm-math-text-center',
		  cssClass:'window[PMGRAPHICID].text36897 pm-math-text-center', 
		  cssStyle:'' , 
		  fontSize:'18' , 
		  strokeColor:'black' });
 /* add panel child */
window[PMGRAPHICID].panel.addChild( window[PMGRAPHICID].board ); 
         ...
         */
        window[PMGRAPHICID].graph41837 = window[PMGRAPHICID].board.create('functiongraph', 
...
tml_368170338(CTNS, CTNS.NUMBERS, CTNS.NUMBERS.GID, SCRIPTBLOCK_ID, FACTORY_ID, GRAPHICBLOCK_ID);
     };