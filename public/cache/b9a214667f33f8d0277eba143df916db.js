  ...
  CTNS.QUIZ_SET["b9a214667f33f8d0277eba143df916db"] = function (PYTHON_ID) {
     ...
     CTNS.QUESTIONS[CTNS_ID] = [
{
    ...
    sponsor: "",
    figure: "",
    key: "QF-VertexOfAParabola",
    label: "Ctns\Question",
    multipleChoice: {a: "True", b: "False" },
    back: " Given a quadratic function in general form  <div class='tex ctns-center' data-expr='f(x) = ax^2+bx+c=0'></div>  the vertex is given by the point  <div class='tex ctns-center' data-expr=' (\\frac{-b}{2a}, f(\\frac{-b}{2a}))'></div>     ",
    commentary: {a:"<scan class='ctns-right'>That answer is correct.</scan>  <!-- rightblock --><div id='rightblock_MASTERID' class='rightblock'></div> ",b:"<scan class='ctns-wrong'>That answer is incorrect.</scan>  <!-- wrongblock --><div id='wrongblock_MASTERID' class='wrongblock'></div> ",undecided:"<scan class='ctns-wrong'>No answer selected.</scan>  <!-- undecidedblock --><div id='undecidedblock_MASTERID' class='undecidedblock'></div> "},
    frontSpeak: " Vertex of a parabola     ",
    backSpeak: " Given a quadratic function in general form  f of x equals -- a times x squared plus b  times x plus c equals zero --  the vertex is given by the point  x equals negative b divided by -- 2 -- a, and y equals f of negative b divided by -- 2 -- a.     ",
