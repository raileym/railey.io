  ...
  CTNS.QUIZ_SET["9732ea6f98df9399f17a317f8b515962"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '2754', 1);
    ...
    */
	...
	jQuery(".slide_2754").each( function() {do_center(this)} );
 ...
 * quiz container.
 */
CTNS.NUMBERS.GID = 'quiz_2754';
CTNS.NUMBERS.equations['quiz_2754'] = [];
CTNS.NUMBERS.symbols['quiz_2754'] = CTNS.NUMBERS.symbols['quiz_2754'] || {};

/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_2754_SlideNo_0'] = CTNS.NUMBERS.symbols['new_scriptblock_2754_SlideNo_0'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_2754'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_2754_SlideNo_0',                ablock           = '#answerblock_2754_SlideNo_0',                acblock          = '#answercommentaryblock_2754_SlideNo_0',                                grblock          = 'graphicblock_2754_SlideNo_0',                grblock_Q        = 'graphicblock_Q_2754_SlideNo_0',                grblock_A        = 'graphicblock_A_2754_SlideNo_0',                grblock_B        = 'graphicblock_B_2754_SlideNo_0',                grblock_C        = 'graphicblock_C_2754_SlideNo_0',                grblock_D        = 'graphicblock_D_2754_SlideNo_0',                grblock_E        = 'graphicblock_E_2754_SlideNo_0',                grblock_F        = 'graphicblock_F_2754_SlideNo_0',                                grblock_f        = (typeof tml_2754_SlideNo_0   !== 'undefined') ? tml_2754_SlideNo_0   : null,                grblock_Q_f      = (typeof tml_Q_2754_SlideNo_0 !== 'undefined') ? tml_Q_2754_SlideNo_0 : null,                grblock_A_f      = (typeof tml_A_2754_SlideNo_0 !== 'undefined') ? tml_A_2754_SlideNo_0 : null,                grblock_B_f      = (typeof tml_B_2754_SlideNo_0 !== 'undefined') ? tml_B_2754_SlideNo_0 : null,                grblock_C_f      = (typeof tml_C_2754_SlideNo_0 !== 'undefined') ? tml_C_2754_SlideNo_0 : null,                grblock_D_f      = (typeof tml_D_2754_SlideNo_0 !== 'undefined') ? tml_D_2754_SlideNo_0 : null,                grblock_E_f      = (typeof tml_E_2754_SlideNo_0 !== 'undefined') ? tml_E_2754_SlideNo_0 : null,                grblock_F_f      = (typeof tml_F_2754_SlideNo_0 !== 'undefined') ? tml_F_2754_SlideNo_0 : null,                numbers          = NUMBERS,                gid              = 'quiz_2754',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_2754_SlideNo_0'],                gsymbols         = NUMBERS.symbols['quiz_2754'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];         /* See Make.php for this dummy entry. A custom script will override this entry. */             [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f,             grblock_E_f,             grblock_F_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D,             grblock_E,             grblock_F].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_2754_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_2754_SlideNo_0
	What do these buy me? tag=, masterid=2754, slideno=SlideNo_0
	'scriptblock_2754_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_2754_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_2754_SlideNo_0'] = NUMBERS.symbols['scriptblock_2754_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_2754_SlideNo_0'];
*/
...
window[PMGRAPHICID].startArrow_39995 = window[PMGRAPHICID].pointD;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_39995 = window[PMGRAPHICID].board.create('point', 
	[ 
	...
	{visible:false});
window[PMGRAPHICID].arrow_39995 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_39995, window[PMGRAPHICID].endArrow_39995], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
...
window[PMGRAPHICID].startArrow_4296 = window[PMGRAPHICID].pointDE;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_4296 = window[PMGRAPHICID].board.create('point', 
	[ 
	...
	{visible:false});
window[PMGRAPHICID].arrow_4296 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_4296, window[PMGRAPHICID].endArrow_4296], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
	...
	arrowType: 'normal',
	strokeColor: 'black'
	});  window[PMGRAPHICID].CPoint_13826 = window[PMGRAPHICID].board.create('point', [ function() { return window[PMGRAPHICID].pointE.X();}, function() { return window[PMGRAPHICID].pointD.Y();} ], {visible:false});window[PMGRAPHICID].poly_13826   = window[PMGRAPHICID].board.create('polygon', [ window[PMGRAPHICID].pointD, window[PMGRAPHICID].pointE, window[PMGRAPHICID].CPoint_13826 ] , { fillColor:'green', withLines:false, strokeColor: '#00FFEE', fillOpacity:0.35} );  
...
window[PMGRAPHICID].text53165 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
	  ...
	  highlightCssClass:'window[PMGRAPHICID].text53165 ', 
	  cssClass:'window[PMGRAPHICID].text53165 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text38536 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text38536 ', 
	  cssClass:'window[PMGRAPHICID].text38536 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text99889 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text99889 ', 
	  cssClass:'window[PMGRAPHICID].text99889 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
