  ...
  CTNS.QUIZ_SET["cc7833155a9e039ea1512953b89c8ac4"] = function (PYTHON_ID) {
     ...
     CTNS.QUESTIONS[CTNS_ID] = [
{
    ...
    frontSpeak: " Field Axioms<br><br>Closure Under Addition     ",
    backSpeak: " A set F is closed under addition if the sum of x plus y is both unique and a member of F for values x and y in F,      ",
