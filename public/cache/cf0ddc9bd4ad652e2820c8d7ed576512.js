  ...
  CTNS.QUIZ_SET["cf0ddc9bd4ad652e2820c8d7ed576512"] = function (PYTHON_ID) {
     ...
     CTNS.QUESTIONS[CTNS_ID] = [
{
    ...
    frontSpeak: " Field Axioms<br><br>Multiplicative Inverse     ",
    backSpeak: " For a set $$\mathbb{F}$$ and all $$x \in \mathbb{F},$$ <br><br>there is an element $$\frac{1}{x} \in \mathbb{F}$$ such that<br> $$x \cdot \left( \frac{1}{x} \right) = 1.$$     ",
