  ...
  CTNS.QUIZ_SET["246b3383678d8e41afc013ae32a08229"] = function (PYTHON_ID) {
     ...
     CTNS.QUESTIONS[CTNS_ID] = [
{
    ...
    frontSpeak: " Field Axioms - Associativity     ",
    backSpeak: " Addition and multiplication are associative for a set F if (x+y)+z = x+(y+z), and if (x * y) * z = x * (y * z) for values x, y, and z in set F.     ",
