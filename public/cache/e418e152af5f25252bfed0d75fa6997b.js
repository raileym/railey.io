  ...
  CTNS.QUIZ_SET["e418e152af5f25252bfed0d75fa6997b"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '1926', 1);
    ...
    */
	...
	jQuery(".slide_1926").each( function() {do_center(this)} );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_1926_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_1926_SlideNo_0
	What do these buy me? tag=, masterid=1926, slideno=SlideNo_0
	'scriptblock_1926_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_1926_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_1926_SlideNo_0'] = NUMBERS.symbols['scriptblock_1926_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_1926_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_50776 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointT, window[PMGRAPHICID].pointB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_50776 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointT, window[PMGRAPHICID].pointB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
	...
	strokeWidth: 4} );
         ...
         */
        window[PMGRAPHICID].graph9384 = window[PMGRAPHICID].board.create('functiongraph', 
