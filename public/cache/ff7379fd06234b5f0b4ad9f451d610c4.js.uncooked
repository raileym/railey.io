  ...
  CTNS.QUIZ_SET["ff7379fd06234b5f0b4ad9f451d610c4"] = function (PYTHON_ID) {
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_1064324870 (CTNS, NUMBERS, GID, SCRIPTBLOCK_ID, FACTORY_ID, GRAPHICBLOCK_ID) {
...
jQuery('button#button'+PMGRAPHICID+'start').click(function(event) {
    ...
    window[PMGRAPHICID].pointb.moveTo([x,y],1000);
         ...
         */
        window[PMGRAPHICID].graph40227 = window[PMGRAPHICID].board.create('functiongraph', 
...
tml_1064324870(CTNS, CTNS.NUMBERS, CTNS.NUMBERS.GID, SCRIPTBLOCK_ID, FACTORY_ID, GRAPHICBLOCK_ID);
     };