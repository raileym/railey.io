  ...
  CTNS.QUIZ_SET["f098c3e4b6507eafe1e6202005e1df7a"] = function (PYTHON_ID) {
     ...
     CTNS.QUESTIONS[CTNS_ID] = [
{
    ...
    frontSpeak: " Axiom     ",
    backSpeak: " An  axiom  is a mathematical statement that serves as the starting point from which all other statements are logically derived. <br><br>An axiom can neither be derived by logic, nor demonstrated by mathematical proof.     ",
