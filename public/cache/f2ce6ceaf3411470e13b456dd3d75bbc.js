  ...
  CTNS.QUIZ_SET["f2ce6ceaf3411470e13b456dd3d75bbc"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '2544', 2);
    ...
    */
	...
	jQuery(".slide_2544").each( function() {do_center(this)} );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_2544_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_2544_SlideNo_0
	What do these buy me? tag=, masterid=2544, slideno=SlideNo_0
	'scriptblock_2544_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_2544_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_2544_SlideNo_0'] = NUMBERS.symbols['scriptblock_2544_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_2544_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_48049 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_48049 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_42374 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointbT, window[PMGRAPHICID].pointbB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_42374 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointbT, window[PMGRAPHICID].pointbB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
	...
	strokeWidth: 4} );
         ...
         */
        window[PMGRAPHICID].graph39548 = window[PMGRAPHICID].board.create('functiongraph', 
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_2544_SlideNo_1 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_2544_SlideNo_1
	What do these buy me? tag=, masterid=2544, slideno=SlideNo_1
	'scriptblock_2544_SlideNo_1'
	*/
	
	PMGRAPHICID   = 'graphicblock_2544_SlideNo_1';
...
/*
    NUMBERS.symbols['scriptblock_2544_SlideNo_1'] = NUMBERS.symbols['scriptblock_2544_SlideNo_1'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_2544_SlideNo_1'];
*/
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_98144 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_98144 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_95176 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointbT, window[PMGRAPHICID].pointbB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_95176 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointbT, window[PMGRAPHICID].pointbB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
	...
	strokeWidth: 4} );
        ...
        /* Generate a particular function
         */
        window[PMGRAPHICID].graph51129 = window[PMGRAPHICID].board.create('functiongraph', 
            [function(x){ return 1/((x-((window[PMGRAPHICID].pointa) ? window[PMGRAPHICID].pointa.X() : 0))*(x-((window[PMGRAPHICID].pointb) ? window[PMGRAPHICID].pointb.X() : 0)));}, 
            -6,
            6], 
            {strokeColor:'black',strokeWidth:5});	 	  
