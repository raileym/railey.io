  ...
  CTNS.QUIZ_SET["026ab56c850573602f773e323b51084b"] = function (PYTHON_ID) {
     ...
     CTNS.QUESTIONS[CTNS_ID] = [
{
    ...
    back: " A <strong>parabola</strong> is the set of all  points <div class='tex' data-expr='(x,y)'></div> in a plane that are equidistant to a fixed point (focus) and to a line (directrix).  <div class='tex ctns-center' data-expr=' \\begin{aligned} (x-h)^2 = 4p(y-k) \\\\ (y-h)^2 = 4p(x-k) \\end{aligned} '></div>     ",
    commentary: {a:"<scan class='ctns-right'>That answer is correct.</scan>  <!-- rightblock --><div id='rightblock_MASTERID' class='rightblock'></div> ",b:"<scan class='ctns-wrong'>That answer is incorrect.</scan>  <!-- wrongblock --><div id='wrongblock_MASTERID' class='wrongblock'></div> ",undecided:"<scan class='ctns-wrong'>No answer selected.</scan>  <!-- undecidedblock --><div id='undecidedblock_MASTERID' class='undecidedblock'></div> "},
    frontSpeak: " Parabola     ",
    backSpeak: " A parabola is the set of all  points in a plane that are equidistant to a fixed point -- the focus  -- and a line -- the directrix.     ",
