  ...
  CTNS.QUIZ_SET["52a2aedc985a6785d4107380309deda0"] = function (PYTHON_ID) {
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_525629862 (CTNS, NUMBERS, GID, SCRIPTBLOCK_ID, FACTORY_ID, GRAPHICBLOCK_ID) {
...
jQuery('button#button'+PMGRAPHICID+'start').click(function(event) {
    ...
    window[PMGRAPHICID].pointb.moveTo([x,y],1000);
         ...
         */
        window[PMGRAPHICID].graph31880 = window[PMGRAPHICID].board.create('functiongraph', 
...
tml_525629862(CTNS, CTNS.NUMBERS, CTNS.NUMBERS.GID, SCRIPTBLOCK_ID, FACTORY_ID, GRAPHICBLOCK_ID);
     };