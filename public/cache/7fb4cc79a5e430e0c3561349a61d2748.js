  ...
  CTNS.QUIZ_SET["7fb4cc79a5e430e0c3561349a61d2748"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '1967', 1);
    ...
    */
	...
	jQuery(".slide_1967").each( function() {do_center(this)} );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_1967_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_1967_SlideNo_0
	What do these buy me? tag=, masterid=1967, slideno=SlideNo_0
	'scriptblock_1967_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_1967_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_1967_SlideNo_0'] = NUMBERS.symbols['scriptblock_1967_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_1967_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_96204 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_96204 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_78167 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointbT, window[PMGRAPHICID].pointbB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_78167 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointbT, window[PMGRAPHICID].pointbB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_83132 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointcT, window[PMGRAPHICID].pointcB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_83132 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointcT, window[PMGRAPHICID].pointcB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
	...
	strokeWidth: 4} );
         ...
         */
        window[PMGRAPHICID].graph3908 = window[PMGRAPHICID].board.create('functiongraph', 
