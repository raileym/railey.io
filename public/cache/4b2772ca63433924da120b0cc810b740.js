  ...
  CTNS.QUIZ_SET["4b2772ca63433924da120b0cc810b740"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '4318', 3);
    ...
    */
	...
	jQuery(".slide_4318").each( function() {do_center(this)} );
 ...
 * quiz container.
 */
CTNS.NUMBERS.GID = 'quiz_4318';
CTNS.NUMBERS.equations['quiz_4318'] = [];
CTNS.NUMBERS.symbols['quiz_4318'] = CTNS.NUMBERS.symbols['quiz_4318'] || {};

/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_4318_SlideNo_0'] = CTNS.NUMBERS.symbols['new_scriptblock_4318_SlideNo_0'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_4318'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_4318_SlideNo_0',                ablock           = '#answerblock_4318_SlideNo_0',                acblock          = '#answercommentaryblock_4318_SlideNo_0',                                grblock          = 'graphicblock_4318_SlideNo_0',                grblock_Q        = 'graphicblock_Q_4318_SlideNo_0',                grblock_A        = 'graphicblock_A_4318_SlideNo_0',                grblock_B        = 'graphicblock_B_4318_SlideNo_0',                grblock_C        = 'graphicblock_C_4318_SlideNo_0',                grblock_D        = 'graphicblock_D_4318_SlideNo_0',                grblock_E        = 'graphicblock_E_4318_SlideNo_0',                grblock_F        = 'graphicblock_F_4318_SlideNo_0',                                grblock_f        = (typeof tml_4318_SlideNo_0   !== 'undefined') ? tml_4318_SlideNo_0   : null,                grblock_Q_f      = (typeof tml_Q_4318_SlideNo_0 !== 'undefined') ? tml_Q_4318_SlideNo_0 : null,                grblock_A_f      = (typeof tml_A_4318_SlideNo_0 !== 'undefined') ? tml_A_4318_SlideNo_0 : null,                grblock_B_f      = (typeof tml_B_4318_SlideNo_0 !== 'undefined') ? tml_B_4318_SlideNo_0 : null,                grblock_C_f      = (typeof tml_C_4318_SlideNo_0 !== 'undefined') ? tml_C_4318_SlideNo_0 : null,                grblock_D_f      = (typeof tml_D_4318_SlideNo_0 !== 'undefined') ? tml_D_4318_SlideNo_0 : null,                grblock_E_f      = (typeof tml_E_4318_SlideNo_0 !== 'undefined') ? tml_E_4318_SlideNo_0 : null,                grblock_F_f      = (typeof tml_F_4318_SlideNo_0 !== 'undefined') ? tml_F_4318_SlideNo_0 : null,                numbers          = NUMBERS,                gid              = 'quiz_4318',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_4318_SlideNo_0'],                gsymbols         = NUMBERS.symbols['quiz_4318'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];         /* See Make.php for this dummy entry. A custom script will override this entry. */             [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f,             grblock_E_f,             grblock_F_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D,             grblock_E,             grblock_F].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_4318_SlideNo_1'] = CTNS.NUMBERS.symbols['new_scriptblock_4318_SlideNo_1'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_4318'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_4318_SlideNo_1',                ablock           = '#answerblock_4318_SlideNo_1',                acblock          = '#answercommentaryblock_4318_SlideNo_1',                                grblock          = 'graphicblock_4318_SlideNo_1',                grblock_Q        = 'graphicblock_Q_4318_SlideNo_1',                grblock_A        = 'graphicblock_A_4318_SlideNo_1',                grblock_B        = 'graphicblock_B_4318_SlideNo_1',                grblock_C        = 'graphicblock_C_4318_SlideNo_1',                grblock_D        = 'graphicblock_D_4318_SlideNo_1',                grblock_E        = 'graphicblock_E_4318_SlideNo_1',                grblock_F        = 'graphicblock_F_4318_SlideNo_1',                                grblock_f        = (typeof tml_4318_SlideNo_1   !== 'undefined') ? tml_4318_SlideNo_1   : null,                grblock_Q_f      = (typeof tml_Q_4318_SlideNo_1 !== 'undefined') ? tml_Q_4318_SlideNo_1 : null,                grblock_A_f      = (typeof tml_A_4318_SlideNo_1 !== 'undefined') ? tml_A_4318_SlideNo_1 : null,                grblock_B_f      = (typeof tml_B_4318_SlideNo_1 !== 'undefined') ? tml_B_4318_SlideNo_1 : null,                grblock_C_f      = (typeof tml_C_4318_SlideNo_1 !== 'undefined') ? tml_C_4318_SlideNo_1 : null,                grblock_D_f      = (typeof tml_D_4318_SlideNo_1 !== 'undefined') ? tml_D_4318_SlideNo_1 : null,                grblock_E_f      = (typeof tml_E_4318_SlideNo_1 !== 'undefined') ? tml_E_4318_SlideNo_1 : null,                grblock_F_f      = (typeof tml_F_4318_SlideNo_1 !== 'undefined') ? tml_F_4318_SlideNo_1 : null,                numbers          = NUMBERS,                gid              = 'quiz_4318',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_4318_SlideNo_1'],                gsymbols         = NUMBERS.symbols['quiz_4318'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];         /* See Make.php for this dummy entry. A custom script will override this entry. */             [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f,             grblock_E_f,             grblock_F_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D,             grblock_E,             grblock_F].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_4318_SlideNo_2'] = CTNS.NUMBERS.symbols['new_scriptblock_4318_SlideNo_2'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_4318'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_4318_SlideNo_2',                ablock           = '#answerblock_4318_SlideNo_2',                acblock          = '#answercommentaryblock_4318_SlideNo_2',                                grblock          = 'graphicblock_4318_SlideNo_2',                grblock_Q        = 'graphicblock_Q_4318_SlideNo_2',                grblock_A        = 'graphicblock_A_4318_SlideNo_2',                grblock_B        = 'graphicblock_B_4318_SlideNo_2',                grblock_C        = 'graphicblock_C_4318_SlideNo_2',                grblock_D        = 'graphicblock_D_4318_SlideNo_2',                grblock_E        = 'graphicblock_E_4318_SlideNo_2',                grblock_F        = 'graphicblock_F_4318_SlideNo_2',                                grblock_f        = (typeof tml_4318_SlideNo_2   !== 'undefined') ? tml_4318_SlideNo_2   : null,                grblock_Q_f      = (typeof tml_Q_4318_SlideNo_2 !== 'undefined') ? tml_Q_4318_SlideNo_2 : null,                grblock_A_f      = (typeof tml_A_4318_SlideNo_2 !== 'undefined') ? tml_A_4318_SlideNo_2 : null,                grblock_B_f      = (typeof tml_B_4318_SlideNo_2 !== 'undefined') ? tml_B_4318_SlideNo_2 : null,                grblock_C_f      = (typeof tml_C_4318_SlideNo_2 !== 'undefined') ? tml_C_4318_SlideNo_2 : null,                grblock_D_f      = (typeof tml_D_4318_SlideNo_2 !== 'undefined') ? tml_D_4318_SlideNo_2 : null,                grblock_E_f      = (typeof tml_E_4318_SlideNo_2 !== 'undefined') ? tml_E_4318_SlideNo_2 : null,                grblock_F_f      = (typeof tml_F_4318_SlideNo_2 !== 'undefined') ? tml_F_4318_SlideNo_2 : null,                numbers          = NUMBERS,                gid              = 'quiz_4318',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_4318_SlideNo_2'],                gsymbols         = NUMBERS.symbols['quiz_4318'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];         /* See Make.php for this dummy entry. A custom script will override this entry. */             [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f,             grblock_E_f,             grblock_F_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D,             grblock_E,             grblock_F].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_4318_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_4318_SlideNo_0
	What do these buy me? tag=, masterid=4318, slideno=SlideNo_0
	'scriptblock_4318_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_4318_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_4318_SlideNo_0'] = NUMBERS.symbols['scriptblock_4318_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_4318_SlideNo_0'];
*/
...
window[PMGRAPHICID].startArrow_3215 = window[PMGRAPHICID].pointD;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_3215 = window[PMGRAPHICID].board.create('point', 
	[ 
	...
	{visible:false});
window[PMGRAPHICID].arrow_3215 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_3215, window[PMGRAPHICID].endArrow_3215], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
...
window[PMGRAPHICID].startArrow_65252 = window[PMGRAPHICID].pointDE;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_65252 = window[PMGRAPHICID].board.create('point', 
	[ 
	...
	{visible:false});
window[PMGRAPHICID].arrow_65252 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_65252, window[PMGRAPHICID].endArrow_65252], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
	...
	arrowType: 'normal',
	strokeColor: 'black'
	});  window[PMGRAPHICID].CPoint_11540 = window[PMGRAPHICID].board.create('point', [ function() { return window[PMGRAPHICID].pointE.X();}, function() { return window[PMGRAPHICID].pointD.Y();} ], {visible:false});window[PMGRAPHICID].poly_11540   = window[PMGRAPHICID].board.create('polygon', [ window[PMGRAPHICID].pointD, window[PMGRAPHICID].pointE, window[PMGRAPHICID].CPoint_11540 ] , { fillColor:'green', withLines:false, strokeColor: '#00FFEE', fillOpacity:0.35} );  
...
window[PMGRAPHICID].text59069 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
	  ...
	  highlightCssClass:'window[PMGRAPHICID].text59069 ', 
	  cssClass:'window[PMGRAPHICID].text59069 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text13445 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text13445 ', 
	  cssClass:'window[PMGRAPHICID].text13445 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 /* Create Text */
window[PMGRAPHICID].text54792 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ cssClass:'window[PMGRAPHICID].text54792 ', cssStyle:'' , fontSize:'18' , strokeColor:'black' } );
 
window[PMGRAPHICID].text48311 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointC.X()+0; }, 
		function() { return window[PMGRAPHICID].pointC.Y()+-1; }, 
		function() { 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text48311 ', 
	  cssClass:'window[PMGRAPHICID].text48311 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_4318_SlideNo_1 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_4318_SlideNo_1
	What do these buy me? tag=, masterid=4318, slideno=SlideNo_1
	'scriptblock_4318_SlideNo_1'
	*/
	
	PMGRAPHICID   = 'graphicblock_4318_SlideNo_1';
...
/*
    NUMBERS.symbols['scriptblock_4318_SlideNo_1'] = NUMBERS.symbols['scriptblock_4318_SlideNo_1'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_4318_SlideNo_1'];
*/
 ...
 */
window[PMGRAPHICID].pointDE = window[PMGRAPHICID].board.create('point', [ function() { return window[PMGRAPHICID].pointE.X();}, function() { return window[PMGRAPHICID].pointD.Y();} ], { visible:true, showInfobox:false, withLabel:false, size:4, fillColor:'blue', strokeColor:'blue'});  
window[PMGRAPHICID].startArrow_30695 = window[PMGRAPHICID].pointD;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_30695 = window[PMGRAPHICID].board.create('point', 
	[ 
	function() { var check = window[PMGRAPHICID].pointDE.X()-window[PMGRAPHICID].pointD.X(); if (check == 0) return window[PMGRAPHICID].pointDE.X(); return (check > 0 ) ? window[PMGRAPHICID].pointDE.X()-0.3 : window[PMGRAPHICID].pointDE.X()+0.3;}, 
	function() { var check = window[PMGRAPHICID].pointDE.Y()-window[PMGRAPHICID].pointD.Y(); if (check == 0) return window[PMGRAPHICID].pointDE.Y(); return (check > 0 ) ? window[PMGRAPHICID].pointDE.Y()-0.3 : window[PMGRAPHICID].pointDE.Y()+0.3;}, 
	], 
	{visible:false});
window[PMGRAPHICID].arrow_30695 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_30695, window[PMGRAPHICID].endArrow_30695], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
...
window[PMGRAPHICID].startArrow_8112 = window[PMGRAPHICID].pointDE;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_8112 = window[PMGRAPHICID].board.create('point', 
	[ 
	function() { var check = window[PMGRAPHICID].pointE.X()-window[PMGRAPHICID].pointDE.X(); if (check == 0) return window[PMGRAPHICID].pointE.X(); return (check > 0 ) ? window[PMGRAPHICID].pointE.X()-0.3 : window[PMGRAPHICID].pointE.X()+0.3;}, 
	function() { var check = window[PMGRAPHICID].pointE.Y()-window[PMGRAPHICID].pointDE.Y(); if (check == 0) return window[PMGRAPHICID].pointE.Y(); return (check > 0 ) ? window[PMGRAPHICID].pointE.Y()-0.3 : window[PMGRAPHICID].pointE.Y()+0.3;}, 
	], 
	{visible:false});
window[PMGRAPHICID].arrow_8112 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_8112, window[PMGRAPHICID].endArrow_8112], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
	...
	arrowType: 'normal',
	strokeColor: 'black'
	});  window[PMGRAPHICID].CPoint_15243 = window[PMGRAPHICID].board.create('point', [ function() { return window[PMGRAPHICID].pointE.X();}, function() { return window[PMGRAPHICID].pointD.Y();} ], {visible:false});window[PMGRAPHICID].poly_15243   = window[PMGRAPHICID].board.create('polygon', [ window[PMGRAPHICID].pointD, window[PMGRAPHICID].pointE, window[PMGRAPHICID].CPoint_15243 ] , { fillColor:'green', withLines:false, strokeColor: '#00FFEE', fillOpacity:0.35} );  
/* Create INLINE pointDDE between two points, window[PMGRAPHICID].pointD and window[PMGRAPHICID].pointDE
 */
window[PMGRAPHICID].pointDDE = window[PMGRAPHICID].board.create('point', [
		function() {
...
window[PMGRAPHICID].text38999 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text38999 ', 
	  cssClass:'window[PMGRAPHICID].text38999 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text41872 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text41872 ', 
	  cssClass:'window[PMGRAPHICID].text41872 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 /* Create Text */
window[PMGRAPHICID].text6851 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ cssClass:'window[PMGRAPHICID].text6851 ', cssStyle:'' , fontSize:'18' , strokeColor:'black' } );
 
window[PMGRAPHICID].text56715 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text56715 ', 
	  cssClass:'window[PMGRAPHICID].text56715 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_4318_SlideNo_2 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_4318_SlideNo_2
	What do these buy me? tag=, masterid=4318, slideno=SlideNo_2
	'scriptblock_4318_SlideNo_2'
	*/
	
	PMGRAPHICID   = 'graphicblock_4318_SlideNo_2';
...
/*
    NUMBERS.symbols['scriptblock_4318_SlideNo_2'] = NUMBERS.symbols['scriptblock_4318_SlideNo_2'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_4318_SlideNo_2'];
*/
 ...
 */
window[PMGRAPHICID].pointDE = window[PMGRAPHICID].board.create('point', [ function() { return window[PMGRAPHICID].pointE.X();}, function() { return window[PMGRAPHICID].pointD.Y();} ], { visible:true, showInfobox:false, withLabel:false, size:4, fillColor:'blue', strokeColor:'blue'});  
window[PMGRAPHICID].startArrow_79064 = window[PMGRAPHICID].pointD;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_79064 = window[PMGRAPHICID].board.create('point', 
	[ 
	function() { var check = window[PMGRAPHICID].pointDE.X()-window[PMGRAPHICID].pointD.X(); if (check == 0) return window[PMGRAPHICID].pointDE.X(); return (check > 0 ) ? window[PMGRAPHICID].pointDE.X()-0.3 : window[PMGRAPHICID].pointDE.X()+0.3;}, 
	function() { var check = window[PMGRAPHICID].pointDE.Y()-window[PMGRAPHICID].pointD.Y(); if (check == 0) return window[PMGRAPHICID].pointDE.Y(); return (check > 0 ) ? window[PMGRAPHICID].pointDE.Y()-0.3 : window[PMGRAPHICID].pointDE.Y()+0.3;}, 
	], 
	{visible:false});
window[PMGRAPHICID].arrow_79064 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_79064, window[PMGRAPHICID].endArrow_79064], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
...
window[PMGRAPHICID].startArrow_24510 = window[PMGRAPHICID].pointDE;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_24510 = window[PMGRAPHICID].board.create('point', 
	[ 
	function() { var check = window[PMGRAPHICID].pointE.X()-window[PMGRAPHICID].pointDE.X(); if (check == 0) return window[PMGRAPHICID].pointE.X(); return (check > 0 ) ? window[PMGRAPHICID].pointE.X()-0.3 : window[PMGRAPHICID].pointE.X()+0.3;}, 
	function() { var check = window[PMGRAPHICID].pointE.Y()-window[PMGRAPHICID].pointDE.Y(); if (check == 0) return window[PMGRAPHICID].pointE.Y(); return (check > 0 ) ? window[PMGRAPHICID].pointE.Y()-0.3 : window[PMGRAPHICID].pointE.Y()+0.3;}, 
	], 
	{visible:false});
window[PMGRAPHICID].arrow_24510 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_24510, window[PMGRAPHICID].endArrow_24510], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
	...
	arrowType: 'normal',
	strokeColor: 'black'
	});  window[PMGRAPHICID].CPoint_24503 = window[PMGRAPHICID].board.create('point', [ function() { return window[PMGRAPHICID].pointE.X();}, function() { return window[PMGRAPHICID].pointD.Y();} ], {visible:false});window[PMGRAPHICID].poly_24503   = window[PMGRAPHICID].board.create('polygon', [ window[PMGRAPHICID].pointD, window[PMGRAPHICID].pointE, window[PMGRAPHICID].CPoint_24503 ] , { fillColor:'green', withLines:false, strokeColor: '#00FFEE', fillOpacity:0.35} );  
/* Create INLINE pointDDE between two points, window[PMGRAPHICID].pointD and window[PMGRAPHICID].pointDE
 */
window[PMGRAPHICID].pointDDE = window[PMGRAPHICID].board.create('point', [
		function() {
...
window[PMGRAPHICID].text77494 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text77494 ', 
	  cssClass:'window[PMGRAPHICID].text77494 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text72622 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text72622 ', 
	  cssClass:'window[PMGRAPHICID].text72622 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
