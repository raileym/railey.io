  ...
  CTNS.QUIZ_SET["ec39332646eb79e22ecf6538708a327d"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '3632', 1);
    ...
    */
	...
	jQuery(".slide_3632").each( function() {do_center(this)} );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_3632_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_3632_SlideNo_0
	What do these buy me? tag=, masterid=3632, slideno=SlideNo_0
	'scriptblock_3632_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_3632_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_3632_SlideNo_0'] = NUMBERS.symbols['scriptblock_3632_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_3632_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_63450 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_63450 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_56776 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointbT, window[PMGRAPHICID].pointbB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_56776 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointbT, window[PMGRAPHICID].pointbB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
	...
	strokeWidth: 4} );
         ...
         */
        window[PMGRAPHICID].graph60164 = window[PMGRAPHICID].board.create('functiongraph', 
