  ...
  CTNS.QUIZ_SET["77d144cd8161d724a91f467bf6da5818"] = function (PYTHON_ID) {
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_1095213203 (CTNS, NUMBERS, GID, SCRIPTBLOCK_ID, FACTORY_ID, GRAPHICBLOCK_ID) {
...
window[PMGRAPHICID].text11681 = window[PMGRAPHICID].panel.create('text', 
        [ 
			-4,7 , 
			function() { 
		...
		{ anchorX:'middle', 
		  ...
		  highlightCssClass:'window[PMGRAPHICID].text11681 pm-math-text-center',
		  cssClass:'window[PMGRAPHICID].text11681 pm-math-text-center', 
		  cssStyle:'' , 
		  fontSize:'18' , 
		  strokeColor:'black' });
 /* add panel child */
window[PMGRAPHICID].panel.addChild( window[PMGRAPHICID].board ); 
         ...
         */
        window[PMGRAPHICID].graph43497 = window[PMGRAPHICID].board.create('functiongraph', 
...
tml_1095213203(CTNS, CTNS.NUMBERS, CTNS.NUMBERS.GID, SCRIPTBLOCK_ID, FACTORY_ID, GRAPHICBLOCK_ID);
     };