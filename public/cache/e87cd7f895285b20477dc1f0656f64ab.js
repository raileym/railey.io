  ...
  CTNS.QUIZ_SET["e87cd7f895285b20477dc1f0656f64ab"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '4445', 1);
    ...
    */
	...
	jQuery(".slide_4445").each( function() {do_center(this)} );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_4445_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_4445_SlideNo_0
	What do these buy me? tag=, masterid=4445, slideno=SlideNo_0
	'scriptblock_4445_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_4445_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_4445_SlideNo_0'] = NUMBERS.symbols['scriptblock_4445_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_4445_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_938 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_938 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
	...
	strokeWidth: 4} );
         ...
         */
        window[PMGRAPHICID].graph20393 = window[PMGRAPHICID].board.create('functiongraph', 
