  ...
  CTNS.QUIZ_SET["7535c54176621e53a6fe4313fd3f8396"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '3847', 1);
    ...
    */
	...
	jQuery(".slide_3847").each( function() {do_center(this)} );
 ...
 * quiz container.
 */
CTNS.NUMBERS.GID = 'quiz_3847';
CTNS.NUMBERS.equations['quiz_3847'] = [];
CTNS.NUMBERS.symbols['quiz_3847'] = CTNS.NUMBERS.symbols['quiz_3847'] || {};

/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_3847_SlideNo_0'] = CTNS.NUMBERS.symbols['new_scriptblock_3847_SlideNo_0'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_3847'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_3847_SlideNo_0',                ablock           = '#answerblock_3847_SlideNo_0',                acblock          = '#answercommentaryblock_3847_SlideNo_0',                                grblock          = 'graphicblock_3847_SlideNo_0',                grblock_Q        = 'graphicblock_Q_3847_SlideNo_0',                grblock_A        = 'graphicblock_A_3847_SlideNo_0',                grblock_B        = 'graphicblock_B_3847_SlideNo_0',                grblock_C        = 'graphicblock_C_3847_SlideNo_0',                grblock_D        = 'graphicblock_D_3847_SlideNo_0',                grblock_E        = 'graphicblock_E_3847_SlideNo_0',                grblock_F        = 'graphicblock_F_3847_SlideNo_0',                                grblock_f        = (typeof tml_3847_SlideNo_0   !== 'undefined') ? tml_3847_SlideNo_0   : null,                grblock_Q_f      = (typeof tml_Q_3847_SlideNo_0 !== 'undefined') ? tml_Q_3847_SlideNo_0 : null,                grblock_A_f      = (typeof tml_A_3847_SlideNo_0 !== 'undefined') ? tml_A_3847_SlideNo_0 : null,                grblock_B_f      = (typeof tml_B_3847_SlideNo_0 !== 'undefined') ? tml_B_3847_SlideNo_0 : null,                grblock_C_f      = (typeof tml_C_3847_SlideNo_0 !== 'undefined') ? tml_C_3847_SlideNo_0 : null,                grblock_D_f      = (typeof tml_D_3847_SlideNo_0 !== 'undefined') ? tml_D_3847_SlideNo_0 : null,                grblock_E_f      = (typeof tml_E_3847_SlideNo_0 !== 'undefined') ? tml_E_3847_SlideNo_0 : null,                grblock_F_f      = (typeof tml_F_3847_SlideNo_0 !== 'undefined') ? tml_F_3847_SlideNo_0 : null,                numbers          = NUMBERS,                gid              = 'quiz_3847',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_3847_SlideNo_0'],                gsymbols         = NUMBERS.symbols['quiz_3847'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];         /* See Make.php for this dummy entry. A custom script will override this entry. */             [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f,             grblock_E_f,             grblock_F_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D,             grblock_E,             grblock_F].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_3847_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_3847_SlideNo_0
	What do these buy me? tag=, masterid=3847, slideno=SlideNo_0
	'scriptblock_3847_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_3847_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_3847_SlideNo_0'] = NUMBERS.symbols['scriptblock_3847_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_3847_SlideNo_0'];
*/
...
window[PMGRAPHICID].condition14461buttonShow = function (ele_name, ele_value) {
...
window[PMGRAPHICID].condition14461buttonHide = function (ele_name, ele_value) {
...
window[PMGRAPHICID].condition14461onTrue = function () {
	if (window[PMGRAPHICID].pointT1)    { window[PMGRAPHICID].condition14461buttonShow('window[PMGRAPHICID].pointT1',   window[PMGRAPHICID].pointT1); }
	if (window[PMGRAPHICID].textT1)     { window[PMGRAPHICID].condition14461buttonShow('window[PMGRAPHICID].textT1',    window[PMGRAPHICID].textT1); }
	if (window[PMGRAPHICID].segmentT1)  { window[PMGRAPHICID].condition14461buttonShow('window[PMGRAPHICID].segmentT1', window[PMGRAPHICID].segmentT1); }
};
window[PMGRAPHICID].condition14461onFalse = function () {
	if (window[PMGRAPHICID].pointT1)    { window[PMGRAPHICID].condition14461buttonHide('window[PMGRAPHICID].pointT1',   window[PMGRAPHICID].pointT1); }
	if (window[PMGRAPHICID].textT1)     { window[PMGRAPHICID].condition14461buttonHide('window[PMGRAPHICID].textT1',    window[PMGRAPHICID].textT1); }
	if (window[PMGRAPHICID].segmentT1)  { window[PMGRAPHICID].condition14461buttonHide('window[PMGRAPHICID].segmentT1', window[PMGRAPHICID].segmentT1); }
};
/* onTrue is set for doCondition.  In this case, we
 * are triggering on the True condition.
 */
window[PMGRAPHICID].updateCondition14461 = function () {
	var x = window[PMGRAPHICID].pointC1.X();
	if (window[PMGRAPHICID].pointC1.X()) {
		window[PMGRAPHICID].condition14461onTrue();
	} else {
		window[PMGRAPHICID].condition14461onFalse();
	}
};

window[PMGRAPHICID].board.on('update', window[PMGRAPHICID].updateCondition14461);
window[PMGRAPHICID].updateCondition14461; 
window[PMGRAPHICID].condition49660buttonShow = function (ele_name, ele_value) {
...
window[PMGRAPHICID].condition49660buttonHide = function (ele_name, ele_value) {
...
window[PMGRAPHICID].condition49660onTrue = function () {
	if (window[PMGRAPHICID].pointT2)    { window[PMGRAPHICID].condition49660buttonShow('window[PMGRAPHICID].pointT2',   window[PMGRAPHICID].pointT2); }
	if (window[PMGRAPHICID].textT2)     { window[PMGRAPHICID].condition49660buttonShow('window[PMGRAPHICID].textT2',    window[PMGRAPHICID].textT2); }
	if (window[PMGRAPHICID].segmentT2)  { window[PMGRAPHICID].condition49660buttonShow('window[PMGRAPHICID].segmentT2', window[PMGRAPHICID].segmentT2); }
};
window[PMGRAPHICID].condition49660onFalse = function () {
	if (window[PMGRAPHICID].pointT2)    { window[PMGRAPHICID].condition49660buttonHide('window[PMGRAPHICID].pointT2',   window[PMGRAPHICID].pointT2); }
	if (window[PMGRAPHICID].textT2)     { window[PMGRAPHICID].condition49660buttonHide('window[PMGRAPHICID].textT2',    window[PMGRAPHICID].textT2); }
	if (window[PMGRAPHICID].segmentT2)  { window[PMGRAPHICID].condition49660buttonHide('window[PMGRAPHICID].segmentT2', window[PMGRAPHICID].segmentT2); }
};
/* onTrue is set for doCondition.  In this case, we
 * are triggering on the True condition.
 */
window[PMGRAPHICID].updateCondition49660 = function () {
	var x = window[PMGRAPHICID].pointC2.X();
	if (window[PMGRAPHICID].pointC2.X()) {
		window[PMGRAPHICID].condition49660onTrue();
	} else {
		window[PMGRAPHICID].condition49660onFalse();
	}
};

window[PMGRAPHICID].board.on('update', window[PMGRAPHICID].updateCondition49660);
window[PMGRAPHICID].updateCondition49660; 
window[PMGRAPHICID].condition17348buttonShow = function (ele_name, ele_value) {
...
window[PMGRAPHICID].condition17348buttonHide = function (ele_name, ele_value) {
...
window[PMGRAPHICID].condition17348onTrue = function () {
	if (window[PMGRAPHICID].pointT3)    { window[PMGRAPHICID].condition17348buttonShow('window[PMGRAPHICID].pointT3',   window[PMGRAPHICID].pointT3); }
	if (window[PMGRAPHICID].textT3)     { window[PMGRAPHICID].condition17348buttonShow('window[PMGRAPHICID].textT3',    window[PMGRAPHICID].textT3); }
	if (window[PMGRAPHICID].segmentT3)  { window[PMGRAPHICID].condition17348buttonShow('window[PMGRAPHICID].segmentT3', window[PMGRAPHICID].segmentT3); }
};
window[PMGRAPHICID].condition17348onFalse = function () {
	if (window[PMGRAPHICID].pointT3)    { window[PMGRAPHICID].condition17348buttonHide('window[PMGRAPHICID].pointT3',   window[PMGRAPHICID].pointT3); }
	if (window[PMGRAPHICID].textT3)     { window[PMGRAPHICID].condition17348buttonHide('window[PMGRAPHICID].textT3',    window[PMGRAPHICID].textT3); }
	if (window[PMGRAPHICID].segmentT3)  { window[PMGRAPHICID].condition17348buttonHide('window[PMGRAPHICID].segmentT3', window[PMGRAPHICID].segmentT3); }
};
/* onTrue is set for doCondition.  In this case, we
 * are triggering on the True condition.
 */
window[PMGRAPHICID].updateCondition17348 = function () {
	var x = window[PMGRAPHICID].pointC3.X();
	if (window[PMGRAPHICID].pointC3.X()) {
		window[PMGRAPHICID].condition17348onTrue();
	} else {
		window[PMGRAPHICID].condition17348onFalse();
	}
};

window[PMGRAPHICID].board.on('update', window[PMGRAPHICID].updateCondition17348);
window[PMGRAPHICID].updateCondition17348; 
