  ...
  CTNS.QUIZ_SET["7a23f1ad5bb913d9d8a73e3b6fda61e1"] = function (PYTHON_ID) {
     ...
     CTNS.QUESTIONS[CTNS_ID] = [
{
    ...
    sponsor: "",
    figure: "",
    key: "QF-TheDiscriminant",
    label: "Ctns\Question",
    multipleChoice: {a: "True", b: "False" },
    back: " Given a quadratic function in general form,  <div class='tex ctns-center' data-expr='ax^2 + bx + c = 0,'></div>  the discriminant is the expression  <div class='tex ctns-center' data-expr='b^2 - 4 a c'></div>     ",
    commentary: {a:"<scan class='ctns-right'>That answer is correct.</scan>  <!-- rightblock --><div id='rightblock_MASTERID' class='rightblock'></div> ",b:"<scan class='ctns-wrong'>That answer is incorrect.</scan>  <!-- wrongblock --><div id='wrongblock_MASTERID' class='wrongblock'></div> ",undecided:"<scan class='ctns-wrong'>No answer selected.</scan>  <!-- undecidedblock --><div id='undecidedblock_MASTERID' class='undecidedblock'></div> "},
    frontSpeak: " Discriminant     ",
    backSpeak: " Given a quadratic function in general form  a -- times x squared plus b -- times x -- plus c equals zero  then the discriminant is the expression  b squared minus 4--a--c.     ",
