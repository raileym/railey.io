  ...
  CTNS.QUIZ_SET["ea1b9d79e4d0cc637f396aa0dd392b44"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '4794', 1);
    ...
    */
	...
	jQuery(".slide_4794").each( function() {do_center(this)} );
 ...
 * quiz container.
 */
CTNS.NUMBERS.GID = 'quiz_4794';
CTNS.NUMBERS.equations['quiz_4794'] = [];
CTNS.NUMBERS.symbols['quiz_4794'] = CTNS.NUMBERS.symbols['quiz_4794'] || {};

/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_4794_SlideNo_0'] = CTNS.NUMBERS.symbols['new_scriptblock_4794_SlideNo_0'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_4794'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_4794_SlideNo_0',                ablock           = '#answerblock_4794_SlideNo_0',                acblock          = '#answercommentaryblock_4794_SlideNo_0',                                grblock          = 'graphicblock_4794_SlideNo_0',                grblock_Q        = 'graphicblock_Q_4794_SlideNo_0',                grblock_A        = 'graphicblock_A_4794_SlideNo_0',                grblock_B        = 'graphicblock_B_4794_SlideNo_0',                grblock_C        = 'graphicblock_C_4794_SlideNo_0',                grblock_D        = 'graphicblock_D_4794_SlideNo_0',                                grblock_f        = (typeof tml_4794_SlideNo_0   !== 'undefined') ? tml_4794_SlideNo_0   : null,                grblock_Q_f      = (typeof tml_Q_4794_SlideNo_0 !== 'undefined') ? tml_Q_4794_SlideNo_0 : null,                grblock_A_f      = (typeof tml_A_4794_SlideNo_0 !== 'undefined') ? tml_A_4794_SlideNo_0 : null,                grblock_B_f      = (typeof tml_B_4794_SlideNo_0 !== 'undefined') ? tml_B_4794_SlideNo_0 : null,                grblock_C_f      = (typeof tml_C_4794_SlideNo_0 !== 'undefined') ? tml_C_4794_SlideNo_0 : null,                grblock_D_f      = (typeof tml_D_4794_SlideNo_0 !== 'undefined') ? tml_D_4794_SlideNo_0 : null,                numbers          = NUMBERS,                gid              = 'quiz_4794',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_4794_SlideNo_0'],                gsymbols         = NUMBERS.symbols['quiz_4794'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];         /* See Make.php for this dummy entry. A custom script will override this entry. */             [grblock_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_A,             grblock_B,             grblock_C,             grblock_D].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_4794_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_4794_SlideNo_0
	What do these buy me? tag=, masterid=4794, slideno=SlideNo_0
	'scriptblock_4794_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_4794_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_4794_SlideNo_0'] = NUMBERS.symbols['scriptblock_4794_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_4794_SlideNo_0'];
*/
...
window[PMGRAPHICID].lineGC = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointG, window[PMGRAPHICID].pointC] , { 
	...
	dash:0,
	strokeWidth: 4} );
  window[PMGRAPHICID].CPoint_96347 = window[PMGRAPHICID].board.create('point', [ function() { return window[PMGRAPHICID].pointG.X();}, function() { return window[PMGRAPHICID].pointA.Y();} ], {visible:false});window[PMGRAPHICID].poly_96347   = window[PMGRAPHICID].board.create('polygon', [ window[PMGRAPHICID].pointA, window[PMGRAPHICID].pointG, window[PMGRAPHICID].CPoint_96347 ] , { fillColor:'green', withLines:false, strokeColor: '#00FFEE', fillOpacity:0.35} );  /*
...
window[PMGRAPHICID].text65873 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
	  ...
	  highlightCssClass:'window[PMGRAPHICID].text65873 ', 
	  cssClass:'window[PMGRAPHICID].text65873 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text34836 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text34836 ', 
	  cssClass:'window[PMGRAPHICID].text34836 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text14851 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text14851 ', 
	  cssClass:'window[PMGRAPHICID].text14851 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
...
window[PMGRAPHICID].text12441 = window[PMGRAPHICID].panel.create('text', 
        [ 
			0,8 , 
			function() { 
				/* Very tricky. Single quotes (not double quotes) are necessary here
		...
		{ anchorX:'middle', 
		  anchorY:'top',
    	  highlightCssStyle:'opacity:1.0', 
		  highlightCssClass:'window[PMGRAPHICID].text12441 pm-math-text-center',
		  cssClass:'window[PMGRAPHICID].text12441 pm-math-text-center', 
		  cssStyle:'' , 
		  fontSize:'20' , 
		  strokeColor:'black' });
  /* add board child */
