  ...
  CTNS.QUIZ_SET["573be97b19953218175f9f90762c8063"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '3348', 1);
    ...
    */
	...
	jQuery(".slide_3348").each( function() {do_center(this)} );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_A_3348_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_A_3348_SlideNo_0
	What do these buy me? tag=A_, masterid=3348, slideno=SlideNo_0
	'scriptblock_3348_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_A_3348_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_3348_SlideNo_0'] = NUMBERS.symbols['scriptblock_3348_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_3348_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_37612 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointT, window[PMGRAPHICID].pointB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_37612 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointT, window[PMGRAPHICID].pointB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_B_3348_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_B_3348_SlideNo_0
	What do these buy me? tag=B_, masterid=3348, slideno=SlideNo_0
	'scriptblock_3348_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_B_3348_SlideNo_0';
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_51031 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointT, window[PMGRAPHICID].pointB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_51031 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointT, window[PMGRAPHICID].pointB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
...
jQuery('button#button'+PMGRAPHICID+'start').click(function(event) {
    ...
    window[PMGRAPHICID].pointz.moveTo([x,y],1000);
         ...
         */
        window[PMGRAPHICID].graph16942 = window[PMGRAPHICID].board.create('functiongraph', 
