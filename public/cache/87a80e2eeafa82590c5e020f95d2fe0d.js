  ...
  CTNS.QUIZ_SET["87a80e2eeafa82590c5e020f95d2fe0d"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '1329', 9);
    ...
    */
	...
	jQuery(".slide_1329").each( function() {do_center(this)} );
 ...
 * quiz container.
 */
CTNS.NUMBERS.GID = 'quiz_1329';
CTNS.NUMBERS.equations['quiz_1329'] = [];
CTNS.NUMBERS.symbols['quiz_1329'] = CTNS.NUMBERS.symbols['quiz_1329'] || {};

/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_1329_SlideNo_0'] = CTNS.NUMBERS.symbols['new_scriptblock_1329_SlideNo_0'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_1329'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_1329_SlideNo_0',                ablock           = '#answerblock_1329_SlideNo_0',                acblock          = '#answercommentaryblock_1329_SlideNo_0',                                grblock          = 'graphicblock_1329_SlideNo_0',                grblock_Q        = 'graphicblock_Q_1329_SlideNo_0',                grblock_A        = 'graphicblock_A_1329_SlideNo_0',                grblock_B        = 'graphicblock_B_1329_SlideNo_0',                grblock_C        = 'graphicblock_C_1329_SlideNo_0',                grblock_D        = 'graphicblock_D_1329_SlideNo_0',                                grblock_f        = (typeof tml_1329_SlideNo_0   !== 'undefined') ? tml_1329_SlideNo_0   : null,                grblock_Q_f      = (typeof tml_Q_1329_SlideNo_0 !== 'undefined') ? tml_Q_1329_SlideNo_0 : null,                grblock_A_f      = (typeof tml_A_1329_SlideNo_0 !== 'undefined') ? tml_A_1329_SlideNo_0 : null,                grblock_B_f      = (typeof tml_B_1329_SlideNo_0 !== 'undefined') ? tml_B_1329_SlideNo_0 : null,                grblock_C_f      = (typeof tml_C_1329_SlideNo_0 !== 'undefined') ? tml_C_1329_SlideNo_0 : null,                grblock_D_f      = (typeof tml_D_1329_SlideNo_0 !== 'undefined') ? tml_D_1329_SlideNo_0 : null,                numbers          = NUMBERS,                gid              = 'quiz_1329',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_1329_SlideNo_0'],                gsymbols         = NUMBERS.symbols['quiz_1329'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];                 do {             symbols.x1 = [-4, -3, -2, -1].ctns_rand();             symbols.y1 = [-4, -3, -2, -1, 1, 2, 3, 4].ctns_rand();             symbols.x2 = [1, 2, 3, 4].ctns_rand();             symbols.y2 = [-4, -3, -2, -1, 1, 2, 3, 4].ctns_rand();         } while( symbols.x1 == symbols.x2 || symbols.y1 == symbols.y2 || is_lt(symbols.y1, symbols.y2) || is_pos(symbols.x1) || is_neg(symbols.x2));          symbols.m = (symbols.y2-symbols.y1)/(symbols.x2-symbols.x1);         symbols.b = symbols.y1 - symbols.x1*symbols.m;          symbols.m_ = d2f( symbols.m );         symbols.b_ = d2f( symbols.b );          symbols.p_x1 = addparen( symbols.x1);         symbols.p_y1 = addparen( symbols.y1);          symbols.EQ = 'y= %s x + %s'.ctns_format([symbols.m_, symbols.b_]).ctns_equation();          q.push(' Consider a line with slope-intercept form $| ${EQ} |$ that connects the two points $$a$$ and $$b$$, <br/><br/> $$ (${x1}, ${y1}) $$ and $$ (${x2}, ${y2}).$$ <br/><br/> The <strong>slope of this line</strong> equals the ratio $$\\frac{\\Delta y}{\\Delta x}$$,<br/><br/> $$\\frac{\\Delta y}{\\Delta x} = \\frac{y_2-y_1}{x_2-x_1} = \\frac{${y2}-${p_y1}}{${x2}-${p_x1}} = ${m_}$$, <br/><br/> where $$(x_1,y_1)$$ corresponds to $$ (${x1}, ${y1}) $$, and <br/>$$(x_2,y_2)$$ corresponds to $$ (${x2}, ${y2}).$$ ');          $(qblock).html(tex({'symbols':symbols}, q.join(' ')));                  [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_1329_SlideNo_1'] = CTNS.NUMBERS.symbols['new_scriptblock_1329_SlideNo_1'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_1329'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_1329_SlideNo_1',                ablock           = '#answerblock_1329_SlideNo_1',                acblock          = '#answercommentaryblock_1329_SlideNo_1',                                grblock          = 'graphicblock_1329_SlideNo_1',                grblock_Q        = 'graphicblock_Q_1329_SlideNo_1',                grblock_A        = 'graphicblock_A_1329_SlideNo_1',                grblock_B        = 'graphicblock_B_1329_SlideNo_1',                grblock_C        = 'graphicblock_C_1329_SlideNo_1',                grblock_D        = 'graphicblock_D_1329_SlideNo_1',                                grblock_f        = (typeof tml_1329_SlideNo_1   !== 'undefined') ? tml_1329_SlideNo_1   : null,                grblock_Q_f      = (typeof tml_Q_1329_SlideNo_1 !== 'undefined') ? tml_Q_1329_SlideNo_1 : null,                grblock_A_f      = (typeof tml_A_1329_SlideNo_1 !== 'undefined') ? tml_A_1329_SlideNo_1 : null,                grblock_B_f      = (typeof tml_B_1329_SlideNo_1 !== 'undefined') ? tml_B_1329_SlideNo_1 : null,                grblock_C_f      = (typeof tml_C_1329_SlideNo_1 !== 'undefined') ? tml_C_1329_SlideNo_1 : null,                grblock_D_f      = (typeof tml_D_1329_SlideNo_1 !== 'undefined') ? tml_D_1329_SlideNo_1 : null,                numbers          = NUMBERS,                gid              = 'quiz_1329',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_1329_SlideNo_1'],                gsymbols         = NUMBERS.symbols['quiz_1329'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];         /* See Make.php for this dummy entry. A custom script will override this entry. */             [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_1329_SlideNo_2'] = CTNS.NUMBERS.symbols['new_scriptblock_1329_SlideNo_2'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_1329'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_1329_SlideNo_2',                ablock           = '#answerblock_1329_SlideNo_2',                acblock          = '#answercommentaryblock_1329_SlideNo_2',                                grblock          = 'graphicblock_1329_SlideNo_2',                grblock_Q        = 'graphicblock_Q_1329_SlideNo_2',                grblock_A        = 'graphicblock_A_1329_SlideNo_2',                grblock_B        = 'graphicblock_B_1329_SlideNo_2',                grblock_C        = 'graphicblock_C_1329_SlideNo_2',                grblock_D        = 'graphicblock_D_1329_SlideNo_2',                                grblock_f        = (typeof tml_1329_SlideNo_2   !== 'undefined') ? tml_1329_SlideNo_2   : null,                grblock_Q_f      = (typeof tml_Q_1329_SlideNo_2 !== 'undefined') ? tml_Q_1329_SlideNo_2 : null,                grblock_A_f      = (typeof tml_A_1329_SlideNo_2 !== 'undefined') ? tml_A_1329_SlideNo_2 : null,                grblock_B_f      = (typeof tml_B_1329_SlideNo_2 !== 'undefined') ? tml_B_1329_SlideNo_2 : null,                grblock_C_f      = (typeof tml_C_1329_SlideNo_2 !== 'undefined') ? tml_C_1329_SlideNo_2 : null,                grblock_D_f      = (typeof tml_D_1329_SlideNo_2 !== 'undefined') ? tml_D_1329_SlideNo_2 : null,                numbers          = NUMBERS,                gid              = 'quiz_1329',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_1329_SlideNo_2'],                gsymbols         = NUMBERS.symbols['quiz_1329'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];         /* See Make.php for this dummy entry. A custom script will override this entry. */             [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_1329_SlideNo_3'] = CTNS.NUMBERS.symbols['new_scriptblock_1329_SlideNo_3'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_1329'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_1329_SlideNo_3',                ablock           = '#answerblock_1329_SlideNo_3',                acblock          = '#answercommentaryblock_1329_SlideNo_3',                                grblock          = 'graphicblock_1329_SlideNo_3',                grblock_Q        = 'graphicblock_Q_1329_SlideNo_3',                grblock_A        = 'graphicblock_A_1329_SlideNo_3',                grblock_B        = 'graphicblock_B_1329_SlideNo_3',                grblock_C        = 'graphicblock_C_1329_SlideNo_3',                grblock_D        = 'graphicblock_D_1329_SlideNo_3',                                grblock_f        = (typeof tml_1329_SlideNo_3   !== 'undefined') ? tml_1329_SlideNo_3   : null,                grblock_Q_f      = (typeof tml_Q_1329_SlideNo_3 !== 'undefined') ? tml_Q_1329_SlideNo_3 : null,                grblock_A_f      = (typeof tml_A_1329_SlideNo_3 !== 'undefined') ? tml_A_1329_SlideNo_3 : null,                grblock_B_f      = (typeof tml_B_1329_SlideNo_3 !== 'undefined') ? tml_B_1329_SlideNo_3 : null,                grblock_C_f      = (typeof tml_C_1329_SlideNo_3 !== 'undefined') ? tml_C_1329_SlideNo_3 : null,                grblock_D_f      = (typeof tml_D_1329_SlideNo_3 !== 'undefined') ? tml_D_1329_SlideNo_3 : null,                numbers          = NUMBERS,                gid              = 'quiz_1329',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_1329_SlideNo_3'],                gsymbols         = NUMBERS.symbols['quiz_1329'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];         /* See Make.php for this dummy entry. A custom script will override this entry. */             [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_1329_SlideNo_4'] = CTNS.NUMBERS.symbols['new_scriptblock_1329_SlideNo_4'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_1329'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_1329_SlideNo_4',                ablock           = '#answerblock_1329_SlideNo_4',                acblock          = '#answercommentaryblock_1329_SlideNo_4',                                grblock          = 'graphicblock_1329_SlideNo_4',                grblock_Q        = 'graphicblock_Q_1329_SlideNo_4',                grblock_A        = 'graphicblock_A_1329_SlideNo_4',                grblock_B        = 'graphicblock_B_1329_SlideNo_4',                grblock_C        = 'graphicblock_C_1329_SlideNo_4',                grblock_D        = 'graphicblock_D_1329_SlideNo_4',                                grblock_f        = (typeof tml_1329_SlideNo_4   !== 'undefined') ? tml_1329_SlideNo_4   : null,                grblock_Q_f      = (typeof tml_Q_1329_SlideNo_4 !== 'undefined') ? tml_Q_1329_SlideNo_4 : null,                grblock_A_f      = (typeof tml_A_1329_SlideNo_4 !== 'undefined') ? tml_A_1329_SlideNo_4 : null,                grblock_B_f      = (typeof tml_B_1329_SlideNo_4 !== 'undefined') ? tml_B_1329_SlideNo_4 : null,                grblock_C_f      = (typeof tml_C_1329_SlideNo_4 !== 'undefined') ? tml_C_1329_SlideNo_4 : null,                grblock_D_f      = (typeof tml_D_1329_SlideNo_4 !== 'undefined') ? tml_D_1329_SlideNo_4 : null,                numbers          = NUMBERS,                gid              = 'quiz_1329',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_1329_SlideNo_4'],                gsymbols         = NUMBERS.symbols['quiz_1329'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];                 do {             symbols.x1 = [-4, -3, -2, -1].ctns_rand();             symbols.y1 = [-4, -3, -2, -1, 1, 2, 3, 4].ctns_rand();             symbols.x2 = [1, 2, 3, 4].ctns_rand();             symbols.y2 = [-4, -3, -2, -1, 1, 2, 3, 4].ctns_rand();         } while( symbols.x1 == symbols.x2 || symbols.y1 == symbols.y2 || is_lt(symbols.y1, symbols.y2) || is_pos(symbols.x1) || is_neg(symbols.x2));          symbols.m = (symbols.y2-symbols.y1)/(symbols.x2-symbols.x1);         symbols.b = symbols.y1 - symbols.x1*symbols.m;          symbols.m_ = d2f( symbols.m );         symbols.b_ = d2f( symbols.b );          symbols.p_x1 = addparen( symbols.x1);         symbols.p_y1 = addparen( symbols.y1);          symbols.EQ = 'y= %s x + %s'.ctns_format([symbols.m_, symbols.b_]).ctns_equation();          q.push(' Consider a line with slope-intercept form $| ${EQ} |$ that connects the two points $$a$$ and $$b$$, <br/><br/> $$ (${x1}, ${y1}) $$ and $$ (${x2}, ${y2}).$$ <br/><br/> The <strong>slope of this line</strong> equals the ratio $$\\frac{\\Delta y}{\\Delta x}$$,<br/><br/> $$\\frac{\\Delta y}{\\Delta x} = \\frac{y_2-y_1}{x_2-x_1} = \\frac{${y2}-${p_y1}}{${x2}-${p_x1}} = ${m_}$$, <br/><br/> where $$(x_1,y_1)$$ corresponds to $$ (${x1}, ${y1}) $$, and <br/>$$(x_2,y_2)$$ corresponds to $$ (${x2}, ${y2}).$$ ');          $(qblock).html(tex({'symbols':symbols}, q.join(' ')));         $(ablock).html(tex({'symbols':symbols}, q.join(' ')));                  [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_1329_SlideNo_5'] = CTNS.NUMBERS.symbols['new_scriptblock_1329_SlideNo_5'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_1329'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_1329_SlideNo_5',                ablock           = '#answerblock_1329_SlideNo_5',                acblock          = '#answercommentaryblock_1329_SlideNo_5',                                grblock          = 'graphicblock_1329_SlideNo_5',                grblock_Q        = 'graphicblock_Q_1329_SlideNo_5',                grblock_A        = 'graphicblock_A_1329_SlideNo_5',                grblock_B        = 'graphicblock_B_1329_SlideNo_5',                grblock_C        = 'graphicblock_C_1329_SlideNo_5',                grblock_D        = 'graphicblock_D_1329_SlideNo_5',                                grblock_f        = (typeof tml_1329_SlideNo_5   !== 'undefined') ? tml_1329_SlideNo_5   : null,                grblock_Q_f      = (typeof tml_Q_1329_SlideNo_5 !== 'undefined') ? tml_Q_1329_SlideNo_5 : null,                grblock_A_f      = (typeof tml_A_1329_SlideNo_5 !== 'undefined') ? tml_A_1329_SlideNo_5 : null,                grblock_B_f      = (typeof tml_B_1329_SlideNo_5 !== 'undefined') ? tml_B_1329_SlideNo_5 : null,                grblock_C_f      = (typeof tml_C_1329_SlideNo_5 !== 'undefined') ? tml_C_1329_SlideNo_5 : null,                grblock_D_f      = (typeof tml_D_1329_SlideNo_5 !== 'undefined') ? tml_D_1329_SlideNo_5 : null,                numbers          = NUMBERS,                gid              = 'quiz_1329',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_1329_SlideNo_5'],                gsymbols         = NUMBERS.symbols['quiz_1329'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];                 do {             symbols.x1 = [-4, -3, -2, -1].ctns_rand();             symbols.y1 = [-4, -3, -2, -1, 1, 2, 3, 4].ctns_rand();             symbols.x2 = [1, 2, 3, 4].ctns_rand();             symbols.y2 = [-4, -3, -2, -1, 1, 2, 3, 4].ctns_rand();         } while( symbols.x1 == symbols.x2 || symbols.y1 == symbols.y2 || is_lt(symbols.y1, symbols.y2) || is_pos(symbols.x1) || is_neg(symbols.x2));          symbols.m = (symbols.y2-symbols.y1)/(symbols.x2-symbols.x1);         symbols.b = symbols.y1 - symbols.x1*symbols.m;          symbols.m_ = d2f( symbols.m );         symbols.b_ = d2f( symbols.b );          symbols.p_x1 = addparen( symbols.x1);         symbols.p_y1 = addparen( symbols.y1);          symbols.EQ = 'y= %s x + %s'.ctns_format([symbols.m_, symbols.b_]).ctns_equation();          q.push(' Consider a line with slope-intercept form $| ${EQ} |$ that connects the two points $$p$$ and $$q$$, <br/><br/> $$ (${x1}, ${y1}) $$ and $$ (${x2}, ${y2}).$$ <br/><br/> The <strong>slope of this line</strong> equals the ratio $$\\frac{\\Delta y}{\\Delta x}$$,<br/><br/> $$\\frac{\\Delta y}{\\Delta x} = \\frac{y_2-y_1}{x_2-x_1} = \\frac{${y2}-${p_y1}}{${x2}-${p_x1}} = ${m_}$$, <br/><br/> where $$(x_1,y_1)$$ corresponds to $$ (${x1}, ${y1}) $$, and <br/>$$(x_2,y_2)$$ corresponds to $$ (${x2}, ${y2}).$$ ');          $(qblock).html(tex({'symbols':symbols}, q.join(' ')));                  [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_1329_SlideNo_6'] = CTNS.NUMBERS.symbols['new_scriptblock_1329_SlideNo_6'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_1329'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_1329_SlideNo_6',                ablock           = '#answerblock_1329_SlideNo_6',                acblock          = '#answercommentaryblock_1329_SlideNo_6',                                grblock          = 'graphicblock_1329_SlideNo_6',                grblock_Q        = 'graphicblock_Q_1329_SlideNo_6',                grblock_A        = 'graphicblock_A_1329_SlideNo_6',                grblock_B        = 'graphicblock_B_1329_SlideNo_6',                grblock_C        = 'graphicblock_C_1329_SlideNo_6',                grblock_D        = 'graphicblock_D_1329_SlideNo_6',                                grblock_f        = (typeof tml_1329_SlideNo_6   !== 'undefined') ? tml_1329_SlideNo_6   : null,                grblock_Q_f      = (typeof tml_Q_1329_SlideNo_6 !== 'undefined') ? tml_Q_1329_SlideNo_6 : null,                grblock_A_f      = (typeof tml_A_1329_SlideNo_6 !== 'undefined') ? tml_A_1329_SlideNo_6 : null,                grblock_B_f      = (typeof tml_B_1329_SlideNo_6 !== 'undefined') ? tml_B_1329_SlideNo_6 : null,                grblock_C_f      = (typeof tml_C_1329_SlideNo_6 !== 'undefined') ? tml_C_1329_SlideNo_6 : null,                grblock_D_f      = (typeof tml_D_1329_SlideNo_6 !== 'undefined') ? tml_D_1329_SlideNo_6 : null,                numbers          = NUMBERS,                gid              = 'quiz_1329',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_1329_SlideNo_6'],                gsymbols         = NUMBERS.symbols['quiz_1329'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];                 do {             symbols.x1 = 0;             symbols.y1 = [0, 1, 2, 3, 4].ctns_rand();             symbols.x2 = [1, 2, 3, 4, 5].ctns_rand();             symbols.y2 = [-4, -3, -2, -1].ctns_rand();         } while( symbols.x1 == symbols.x2 || symbols.y1 == symbols.y2 || is_pos(symbols.x1) || is_neg(symbols.x2) );          symbols.m = (symbols.y2-symbols.y1)/(symbols.x2-symbols.x1);         symbols.b = symbols.y1 - symbols.x1*symbols.m;          symbols.m_ = d2f( symbols.m );         symbols.p_x1 = addparen( symbols.x1 );         symbols.p_y1 = addparen( symbols.y1 );          q.push(' Consider a line with slope-intercept form<br/><br/> $$y = ${m_}x+\\color{blue}{${b}}$$<br/><br/> that connects the two points $$p$$ and $$q$$, <br/><br/> $$ (${x1}, \\color{blue}{${y1}}) $$ and $$ (${x2}, ${y2}),$$ <br/><br/> where the <strong>$$y$$-intercept</strong> is $$\\color{blue} b = ${b}$$, and the <strong>slope</strong> is $$m = ${m_}, $$<br/><br/> $$\\frac{\\Delta y}{\\Delta x} = \\frac{y_2-y_1}{x_2-x_1} = \\frac{${y2}-${p_y1}}{${x2}-${p_x1}} = ${m_}$$. ');          $(qblock).html(tex({'symbols':symbols}, q.join(' ')));                  [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_1329_SlideNo_7'] = CTNS.NUMBERS.symbols['new_scriptblock_1329_SlideNo_7'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_1329'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_1329_SlideNo_7',                ablock           = '#answerblock_1329_SlideNo_7',                acblock          = '#answercommentaryblock_1329_SlideNo_7',                                grblock          = 'graphicblock_1329_SlideNo_7',                grblock_Q        = 'graphicblock_Q_1329_SlideNo_7',                grblock_A        = 'graphicblock_A_1329_SlideNo_7',                grblock_B        = 'graphicblock_B_1329_SlideNo_7',                grblock_C        = 'graphicblock_C_1329_SlideNo_7',                grblock_D        = 'graphicblock_D_1329_SlideNo_7',                                grblock_f        = (typeof tml_1329_SlideNo_7   !== 'undefined') ? tml_1329_SlideNo_7   : null,                grblock_Q_f      = (typeof tml_Q_1329_SlideNo_7 !== 'undefined') ? tml_Q_1329_SlideNo_7 : null,                grblock_A_f      = (typeof tml_A_1329_SlideNo_7 !== 'undefined') ? tml_A_1329_SlideNo_7 : null,                grblock_B_f      = (typeof tml_B_1329_SlideNo_7 !== 'undefined') ? tml_B_1329_SlideNo_7 : null,                grblock_C_f      = (typeof tml_C_1329_SlideNo_7 !== 'undefined') ? tml_C_1329_SlideNo_7 : null,                grblock_D_f      = (typeof tml_D_1329_SlideNo_7 !== 'undefined') ? tml_D_1329_SlideNo_7 : null,                numbers          = NUMBERS,                gid              = 'quiz_1329',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_1329_SlideNo_7'],                gsymbols         = NUMBERS.symbols['quiz_1329'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];                 do {             symbols.x1 = [-4, -3, -2, -1            ].ctns_rand();             symbols.y1 = [-4, -3, -2, -1, 1, 2, 3, 4].ctns_rand();             symbols.x2 = [1, 2, 3, 4                ].ctns_rand();             symbols.y2 = [-4, -3, -2, -1, 1, 2, 3, 4].ctns_rand();         } while( symbols.x1 == symbols.x2 || symbols.y1 == symbols.y2 );          symbols.m = (symbols.y2-symbols.y1)/(symbols.x2-symbols.x1);         symbols.b = symbols.y1 - symbols.x1*symbols.m;          symbols.m_ = d2f( symbols.m );         symbols.p_x1 = addparen( symbols.x1);         symbols.p_y1 = addparen( symbols.y1);          symbols.EQ = 'y - %s = %s ( x - %s )'.ctns_format([symbols.y1, symbols.m_, symbols.x1]).ctns_equation();          q.push(' Consider a line with point-slope form $| ${EQ} |$ that connects the two points $$p$$ and $$q$$, <br/><br/> $$ (${x1}, ${y1}) $$ and $$ (${x2}, ${y2}),$$ <br/><br/> where the <strong>slope</strong> is $$m = ${m_}, $$<br/><br/> $$\\frac{\\Delta y}{\\Delta x} = \\frac{y_2-y_1}{x_2-x_1} = \\frac{${y2}-${p_y1}}{${x2}-${p_x1}} = ${m_}$$. ');          $(qblock).html(tex({'symbols':symbols}, q.join(' ')));                  [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_1329_SlideNo_8'] = CTNS.NUMBERS.symbols['new_scriptblock_1329_SlideNo_8'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_1329'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_1329_SlideNo_8',                ablock           = '#answerblock_1329_SlideNo_8',                acblock          = '#answercommentaryblock_1329_SlideNo_8',                                grblock          = 'graphicblock_1329_SlideNo_8',                grblock_Q        = 'graphicblock_Q_1329_SlideNo_8',                grblock_A        = 'graphicblock_A_1329_SlideNo_8',                grblock_B        = 'graphicblock_B_1329_SlideNo_8',                grblock_C        = 'graphicblock_C_1329_SlideNo_8',                grblock_D        = 'graphicblock_D_1329_SlideNo_8',                                grblock_f        = (typeof tml_1329_SlideNo_8   !== 'undefined') ? tml_1329_SlideNo_8   : null,                grblock_Q_f      = (typeof tml_Q_1329_SlideNo_8 !== 'undefined') ? tml_Q_1329_SlideNo_8 : null,                grblock_A_f      = (typeof tml_A_1329_SlideNo_8 !== 'undefined') ? tml_A_1329_SlideNo_8 : null,                grblock_B_f      = (typeof tml_B_1329_SlideNo_8 !== 'undefined') ? tml_B_1329_SlideNo_8 : null,                grblock_C_f      = (typeof tml_C_1329_SlideNo_8 !== 'undefined') ? tml_C_1329_SlideNo_8 : null,                grblock_D_f      = (typeof tml_D_1329_SlideNo_8 !== 'undefined') ? tml_D_1329_SlideNo_8 : null,                numbers          = NUMBERS,                gid              = 'quiz_1329',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_1329_SlideNo_8'],                gsymbols         = NUMBERS.symbols['quiz_1329'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];                 symbols.a = 2;         symbols.b = 2;          symbols.a_ = [1, 2, 3, -1, -2, -3].ctns_rand();         symbols.b_ = [1, 2, 3, 4, -1, -2, -3, -4].ctns_rand();          symbols.a = {};         symbols.b = {};         symbols.c = {};         symbols.d = {};          if ( is_pos(symbols.a_) && is_pos(symbols.b_) ) {             symbols.a.x = -0.5;             symbols.a.y = symbols.a_ - 0.25;             symbols.b.x = symbols.b_ + 0.5;             symbols.b.y = 0.75;             symbols.c.x = 2;             symbols.c.y = 4.5;             symbols.d.x = -2;             symbols.d.y = -4;         } else if ( is_pos(symbols.a_) && is_neg(symbols.b_) ) {             symbols.a.x = 0.25;             symbols.a.y = symbols.a_ - 0.25;             symbols.b.x = symbols.b_ - 0.75;             symbols.b.y = 0.75;             symbols.c.x = -2;             symbols.c.y = 4.5;             symbols.d.x = 2;             symbols.d.y = -4;         } else if ( is_neg(symbols.a_) && is_pos(symbols.b_) ) {             symbols.a.x = 0.25;             symbols.a.y = symbols.a_ - 0.25;             symbols.b.x = symbols.b_ - 0.75;             symbols.b.y = 0.75;             symbols.c.x = -3;             symbols.c.y = 1.5;             symbols.d.x = 3;             symbols.d.y = -4;         } else {             symbols.a.x = -0.5;             symbols.a.y = symbols.a_ - 0.25;             symbols.b.x = symbols.b_ + 0.5;             symbols.b.y = 0.75;             symbols.c.x = 1;             symbols.c.y = 1.5;             symbols.d.x = -3;             symbols.d.y = -4;         }          q.push(tex({'symbols':symbols},' Consider a line in <strong>intercept-intercept form</strong><br/><br/> $$\\frac{x}{${b_}} + \\frac{y}{${a_}} = 1$$ <br/><br/>that connects the two points $$a$$ and $$b$$, <br/><br/> $$(0, ${a_})$$ and $$(${b_}, 0),$$ <br/><br/> '));          q.push(tex({'symbols':symbols},' where the <strong>$$y$$-intercept</strong> is $$ ${a_} $$, and the <strong>$$x$$-intercept</strong> is $$ ${b_} $$. '));          $(qblock).html(q.join(' '));                  [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_1329_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_1329_SlideNo_0
	What do these buy me? tag=, masterid=1329, slideno=SlideNo_0
	'scriptblock_1329_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_1329_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_1329_SlideNo_0'] = NUMBERS.symbols['scriptblock_1329_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_1329_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_12690 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointp, window[PMGRAPHICID].pointq] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'blue',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_12690 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointp, window[PMGRAPHICID].pointq] , { 
	visible:true,
	straightFirst: true, 
	straightLast: true, 
	strokeColor:'blue',
...
window[PMGRAPHICID].startArrow_22288 = window[PMGRAPHICID].pointr;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_22288 = window[PMGRAPHICID].board.create('point', 
	[ 
	...
	{visible:false});
window[PMGRAPHICID].arrow_22288 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_22288, window[PMGRAPHICID].endArrow_22288], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
...
window[PMGRAPHICID].text69317 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ cssClass:'window[PMGRAPHICID].text69317 center', cssStyle:'' , fontSize:'18' , strokeColor:'black' } );
 
window[PMGRAPHICID].text87911 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointr.X()+1; }, 
	...
	{ anchorX:'middle', 
	  ...
	  highlightCssClass:'window[PMGRAPHICID].text87911 center', 
	  cssClass:'window[PMGRAPHICID].text87911 center', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text15128 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointr.X()+1; }, 
		function() { return window[PMGRAPHICID].pointr.Y()+-0.5; }, 
		function() { 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text15128 center', 
	  cssClass:'window[PMGRAPHICID].text15128 center', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_1329_SlideNo_1 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_1329_SlideNo_1
	What do these buy me? tag=, masterid=1329, slideno=SlideNo_1
	'scriptblock_1329_SlideNo_1'
	*/
	
	PMGRAPHICID   = 'graphicblock_1329_SlideNo_1';
...
/*
    NUMBERS.symbols['scriptblock_1329_SlideNo_1'] = NUMBERS.symbols['scriptblock_1329_SlideNo_1'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_1329_SlideNo_1'];
*/
...
window[PMGRAPHICID].lineBC = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointB, window[PMGRAPHICID].pointC] , { 
	...
	dash:0,
	strokeWidth: 4} );
  window[PMGRAPHICID].CPoint_54357 = window[PMGRAPHICID].board.create('point', [ function() { return window[PMGRAPHICID].pointB.X();}, function() { return window[PMGRAPHICID].pointA.Y();} ], {visible:false});window[PMGRAPHICID].poly_54357   = window[PMGRAPHICID].board.create('polygon', [ window[PMGRAPHICID].pointA, window[PMGRAPHICID].pointB, window[PMGRAPHICID].CPoint_54357 ] , { fillColor:'green', withLines:false, strokeColor: '#00FFEE', fillOpacity:0.35} );  /*
...
window[PMGRAPHICID].text59436 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text59436 ', 
	  cssClass:'window[PMGRAPHICID].text59436 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
  
window[PMGRAPHICID].text69142 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text69142 ', 
	  cssClass:'window[PMGRAPHICID].text69142 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
  
window[PMGRAPHICID].text32086 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text32086 ', 
	  cssClass:'window[PMGRAPHICID].text32086 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text63348 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text63348 ', 
	  cssClass:'window[PMGRAPHICID].text63348 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
...
window[PMGRAPHICID].text45978 = window[PMGRAPHICID].panel.create('text', 
        [ 
			0,9 , 
			function() { 
				/* Very tricky. Single quotes (not double quotes) are necessary here
		...
		{ anchorX:'middle', 
		  anchorY:'middle',
    	  highlightCssStyle:'opacity:1.0', 
		  highlightCssClass:'window[PMGRAPHICID].text45978 pm-math-text-center',
		  cssClass:'window[PMGRAPHICID].text45978 pm-math-text-center', 
		  cssStyle:'' , 
		  fontSize:'18' , 
		  strokeColor:'black' });
 
window[PMGRAPHICID].text76322 = window[PMGRAPHICID].panel.create('text', 
        [ 
			0,6 , 
			function() { 
				/* Very tricky. Single quotes (not double quotes) are necessary here
		...
		{ anchorX:'middle', 
		  anchorY:'middle',
    	  highlightCssStyle:'opacity:1.0', 
		  highlightCssClass:'window[PMGRAPHICID].text76322 pm-math-text-center',
		  cssClass:'window[PMGRAPHICID].text76322 pm-math-text-center', 
		  cssStyle:'' , 
		  fontSize:'18' , 
		  strokeColor:'black' });
 /* add board child */
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_1329_SlideNo_2 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_1329_SlideNo_2
	What do these buy me? tag=, masterid=1329, slideno=SlideNo_2
	'scriptblock_1329_SlideNo_2'
	*/
	
	PMGRAPHICID   = 'graphicblock_1329_SlideNo_2';
...
/*
    NUMBERS.symbols['scriptblock_1329_SlideNo_2'] = NUMBERS.symbols['scriptblock_1329_SlideNo_2'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_1329_SlideNo_2'];
*/
...
window[PMGRAPHICID].lineGC = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointG, window[PMGRAPHICID].pointC] , { 
	...
	dash:0,
	strokeWidth: 4} );
  window[PMGRAPHICID].CPoint_35218 = window[PMGRAPHICID].board.create('point', [ function() { return window[PMGRAPHICID].pointG.X();}, function() { return window[PMGRAPHICID].pointA.Y();} ], {visible:false});window[PMGRAPHICID].poly_35218   = window[PMGRAPHICID].board.create('polygon', [ window[PMGRAPHICID].pointA, window[PMGRAPHICID].pointG, window[PMGRAPHICID].CPoint_35218 ] , { fillColor:'green', withLines:false, strokeColor: '#00FFEE', fillOpacity:0.35} );  /*
...
window[PMGRAPHICID].text34230 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointE.X()+0.5; }, 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text34230 ', 
	  cssClass:'window[PMGRAPHICID].text34230 ', 
	  cssStyle:'background-color:rgba(255,0,0,1);' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text41407 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointD.X()+-0.5; }, 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text41407 ', 
	  cssClass:'window[PMGRAPHICID].text41407 ', 
	  cssStyle:'background-color:rgba(255,0,0,1);' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
		...
		window[PMGRAPHICID].panel = JXG.JSXGraph.initBoard(PMGRAPHICID+'panel', {boundingbox: [-10,11,10,-1], showNavigation:false, showCopyright:false}); 
window[PMGRAPHICID].text95018 = window[PMGRAPHICID].panel.create('text', 
        [ 
			0,8 , 
			function() { 
				/* Very tricky. Single quotes (not double quotes) are necessary here
		...
		{ anchorX:'middle', 
		  anchorY:'top',
    	  highlightCssStyle:'opacity:1.0', 
		  highlightCssClass:'window[PMGRAPHICID].text95018 pm-math-text-center',
		  cssClass:'window[PMGRAPHICID].text95018 pm-math-text-center', 
		  cssStyle:'' , 
		  fontSize:'20' , 
		  strokeColor:'black' });
 /* add board child */
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_1329_SlideNo_3 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_1329_SlideNo_3
	What do these buy me? tag=, masterid=1329, slideno=SlideNo_3
	'scriptblock_1329_SlideNo_3'
	*/
	
	PMGRAPHICID   = 'graphicblock_1329_SlideNo_3';
...
/*
    NUMBERS.symbols['scriptblock_1329_SlideNo_3'] = NUMBERS.symbols['scriptblock_1329_SlideNo_3'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_1329_SlideNo_3'];
*/
...
window[PMGRAPHICID].lineGC = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointG, window[PMGRAPHICID].pointC] , { 
	...
	dash:0,
	strokeWidth: 4} );
  window[PMGRAPHICID].CPoint_82695 = window[PMGRAPHICID].board.create('point', [ function() { return window[PMGRAPHICID].pointG.X();}, function() { return window[PMGRAPHICID].pointA.Y();} ], {visible:false});window[PMGRAPHICID].poly_82695   = window[PMGRAPHICID].board.create('polygon', [ window[PMGRAPHICID].pointA, window[PMGRAPHICID].pointG, window[PMGRAPHICID].CPoint_82695 ] , { fillColor:'green', withLines:false, strokeColor: '#00FFEE', fillOpacity:0.35} );  /*
 * Expected Calculation on G.y-C.y
 */
/*
 * Calculate on C1: ((window[PMGRAPHICID].pointG) ? window[PMGRAPHICID].pointG.Y() : 0)-((window[PMGRAPHICID].pointC) ? window[PMGRAPHICID].pointC.Y() : 0)
...
window[PMGRAPHICID].text81965 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text81965 ', 
	  cssClass:'window[PMGRAPHICID].text81965 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text20194 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text20194 ', 
	  cssClass:'window[PMGRAPHICID].text20194 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text38084 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text38084 ', 
	  cssClass:'window[PMGRAPHICID].text38084 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
		...
		window[PMGRAPHICID].panel = JXG.JSXGraph.initBoard(PMGRAPHICID+'panel', {boundingbox: [-10,11,10,-1], showNavigation:false, showCopyright:false});  
window[PMGRAPHICID].text14227 = window[PMGRAPHICID].panel.create('text', 
        [ 
			0,8 , 
			function() { 
				/* Very tricky. Single quotes (not double quotes) are necessary here
		...
		{ anchorX:'middle', 
		  anchorY:'top',
    	  highlightCssStyle:'opacity:1.0', 
		  highlightCssClass:'window[PMGRAPHICID].text14227 pm-math-text-center',
		  cssClass:'window[PMGRAPHICID].text14227 pm-math-text-center', 
		  cssStyle:'' , 
		  fontSize:'20' , 
		  strokeColor:'black' });
  /* add board child */
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_Q_1329_SlideNo_4 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_Q_1329_SlideNo_4
	What do these buy me? tag=Q_, masterid=1329, slideno=SlideNo_4
	'scriptblock_1329_SlideNo_4'
	*/
	
	PMGRAPHICID   = 'graphicblock_Q_1329_SlideNo_4';
...
/*
    NUMBERS.symbols['scriptblock_1329_SlideNo_4'] = NUMBERS.symbols['scriptblock_1329_SlideNo_4'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_1329_SlideNo_4'];
*/
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_71953 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointp, window[PMGRAPHICID].pointq] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'blue',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_71953 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointp, window[PMGRAPHICID].pointq] , { 
	visible:true,
	straightFirst: true, 
	straightLast: true, 
	strokeColor:'blue',
...
window[PMGRAPHICID].startArrow_68144 = window[PMGRAPHICID].pointr;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_68144 = window[PMGRAPHICID].board.create('point', 
	[ 
	function() { var check = window[PMGRAPHICID].pointb.X()-window[PMGRAPHICID].pointr.X(); if (check == 0) return window[PMGRAPHICID].pointb.X(); return (check > 0 ) ? window[PMGRAPHICID].pointb.X()-0.3 : window[PMGRAPHICID].pointb.X()+0.3;}, 
	function() { var check = window[PMGRAPHICID].pointb.Y()-window[PMGRAPHICID].pointr.Y(); if (check == 0) return window[PMGRAPHICID].pointb.Y(); return (check > 0 ) ? window[PMGRAPHICID].pointb.Y()-0.3 : window[PMGRAPHICID].pointb.Y()+0.3;}, 
	], 
	{visible:false});
window[PMGRAPHICID].arrow_68144 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_68144, window[PMGRAPHICID].endArrow_68144], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_A_1329_SlideNo_4 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_A_1329_SlideNo_4
	What do these buy me? tag=A_, masterid=1329, slideno=SlideNo_4
	'scriptblock_1329_SlideNo_4'
	*/
	
	PMGRAPHICID   = 'graphicblock_A_1329_SlideNo_4';
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_45649 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointp, window[PMGRAPHICID].pointq] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_45649 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointp, window[PMGRAPHICID].pointq] , { 
	visible:true,
	straightFirst: true, 
	straightLast: true, 
	strokeColor:'red',
...
window[PMGRAPHICID].startArrow_53484 = window[PMGRAPHICID].pointr;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_53484 = window[PMGRAPHICID].board.create('point', 
	[ 
	function() { var check = window[PMGRAPHICID].pointb.X()-window[PMGRAPHICID].pointr.X(); if (check == 0) return window[PMGRAPHICID].pointb.X(); return (check > 0 ) ? window[PMGRAPHICID].pointb.X()-0.3 : window[PMGRAPHICID].pointb.X()+0.3;}, 
	function() { var check = window[PMGRAPHICID].pointb.Y()-window[PMGRAPHICID].pointr.Y(); if (check == 0) return window[PMGRAPHICID].pointb.Y(); return (check > 0 ) ? window[PMGRAPHICID].pointb.Y()-0.3 : window[PMGRAPHICID].pointb.Y()+0.3;}, 
	], 
	{visible:false});
window[PMGRAPHICID].arrow_53484 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_53484, window[PMGRAPHICID].endArrow_53484], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
...
window[PMGRAPHICID].text31930 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointr.X()+-1; }, 
		function() { return window[PMGRAPHICID].pointr.Y()+0; }, 
		function() { 
	...
	{ cssClass:'window[PMGRAPHICID].text31930 center', cssStyle:'' , fontSize:'18' , strokeColor:'black' } );
 
window[PMGRAPHICID].text95645 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointr.X()+1; }, 
		function() { return window[PMGRAPHICID].pointr.Y()+0.5; }, 
		function() { 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text95645 center', 
	  cssClass:'window[PMGRAPHICID].text95645 center', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text58633 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointr.X()+1; }, 
		function() { return window[PMGRAPHICID].pointr.Y()+-0.5; }, 
		function() { 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text58633 center', 
	  cssClass:'window[PMGRAPHICID].text58633 center', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_1329_SlideNo_5 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_1329_SlideNo_5
	What do these buy me? tag=, masterid=1329, slideno=SlideNo_5
	'scriptblock_1329_SlideNo_5'
	*/
	
	PMGRAPHICID   = 'graphicblock_1329_SlideNo_5';
...
/*
    NUMBERS.symbols['scriptblock_1329_SlideNo_5'] = NUMBERS.symbols['scriptblock_1329_SlideNo_5'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_1329_SlideNo_5'];
*/
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_50541 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointp, window[PMGRAPHICID].pointq] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'blue',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_50541 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointp, window[PMGRAPHICID].pointq] , { 
	visible:true,
	straightFirst: true, 
	straightLast: true, 
	strokeColor:'blue',
	...
	strokeWidth: 4} );
 /* Create Text */
window[PMGRAPHICID].text53608 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointr.X()+-1; }, 
		function() { return window[PMGRAPHICID].pointr.Y()+0; }, 
		function() { 
	...
	{ cssClass:'window[PMGRAPHICID].text53608 center', cssStyle:'' , fontSize:'18' , strokeColor:'black' } );
 
window[PMGRAPHICID].startArrow_90937 = window[PMGRAPHICID].pointr;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_90937 = window[PMGRAPHICID].board.create('point', 
	[ 
	function() { var check = window[PMGRAPHICID].pointb.X()-window[PMGRAPHICID].pointr.X(); if (check == 0) return window[PMGRAPHICID].pointb.X(); return (check > 0 ) ? window[PMGRAPHICID].pointb.X()-0.3 : window[PMGRAPHICID].pointb.X()+0.3;}, 
	function() { var check = window[PMGRAPHICID].pointb.Y()-window[PMGRAPHICID].pointr.Y(); if (check == 0) return window[PMGRAPHICID].pointb.Y(); return (check > 0 ) ? window[PMGRAPHICID].pointb.Y()-0.3 : window[PMGRAPHICID].pointb.Y()+0.3;}, 
	], 
	{visible:false});
window[PMGRAPHICID].arrow_90937 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_90937, window[PMGRAPHICID].endArrow_90937], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
...
window[PMGRAPHICID].text72023 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointr.X()+1; }, 
		function() { return window[PMGRAPHICID].pointr.Y()+0.5; }, 
		function() { 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text72023 center', 
	  cssClass:'window[PMGRAPHICID].text72023 center', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text75425 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointr.X()+1; }, 
		function() { return window[PMGRAPHICID].pointr.Y()+-0.5; }, 
		function() { 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text75425 center', 
	  cssClass:'window[PMGRAPHICID].text75425 center', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_1329_SlideNo_6 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_1329_SlideNo_6
	What do these buy me? tag=, masterid=1329, slideno=SlideNo_6
	'scriptblock_1329_SlideNo_6'
	*/
	
	PMGRAPHICID   = 'graphicblock_1329_SlideNo_6';
...
/*
    NUMBERS.symbols['scriptblock_1329_SlideNo_6'] = NUMBERS.symbols['scriptblock_1329_SlideNo_6'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_1329_SlideNo_6'];
*/
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_16839 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointp, window[PMGRAPHICID].pointq] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'blue',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_16839 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointp, window[PMGRAPHICID].pointq] , { 
	visible:true,
	straightFirst: true, 
	straightLast: true, 
	strokeColor:'blue',
...
window[PMGRAPHICID].startArrow_25351 = window[PMGRAPHICID].pointr;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_25351 = window[PMGRAPHICID].board.create('point', 
	[ 
	...
	{visible:false});
window[PMGRAPHICID].arrow_25351 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_25351, window[PMGRAPHICID].endArrow_25351], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
...
window[PMGRAPHICID].text65994 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointr.X()+-1; }, 
		function() { return window[PMGRAPHICID].pointr.Y()+0; }, 
		function() { 
	...
	{ cssClass:'window[PMGRAPHICID].text65994 center', cssStyle:'' , fontSize:'18' , strokeColor:'black' } );
 
window[PMGRAPHICID].text99212 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointr.X()+1; }, 
		function() { return window[PMGRAPHICID].pointr.Y()+0.5; }, 
		function() { 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text99212 center', 
	  cssClass:'window[PMGRAPHICID].text99212 center', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text59745 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointr.X()+1; }, 
		function() { return window[PMGRAPHICID].pointr.Y()+-0.5; }, 
		function() { 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text59745 center', 
	  cssClass:'window[PMGRAPHICID].text59745 center', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_1329_SlideNo_7 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_1329_SlideNo_7
	What do these buy me? tag=, masterid=1329, slideno=SlideNo_7
	'scriptblock_1329_SlideNo_7'
	*/
	
	PMGRAPHICID   = 'graphicblock_1329_SlideNo_7';
...
/*
    NUMBERS.symbols['scriptblock_1329_SlideNo_7'] = NUMBERS.symbols['scriptblock_1329_SlideNo_7'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_1329_SlideNo_7'];
*/
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_29400 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointp, window[PMGRAPHICID].pointq] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'blue',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_29400 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointp, window[PMGRAPHICID].pointq] , { 
	visible:true,
	straightFirst: true, 
	straightLast: true, 
	strokeColor:'blue',
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_1329_SlideNo_8 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_1329_SlideNo_8
	What do these buy me? tag=, masterid=1329, slideno=SlideNo_8
	'scriptblock_1329_SlideNo_8'
	*/
	
	PMGRAPHICID   = 'graphicblock_1329_SlideNo_8';
...
/*
    NUMBERS.symbols['scriptblock_1329_SlideNo_8'] = NUMBERS.symbols['scriptblock_1329_SlideNo_8'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_1329_SlideNo_8'];
*/
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_98024 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointa_, window[PMGRAPHICID].pointb_] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'blue',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_98024 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointa_, window[PMGRAPHICID].pointb_] , { 
	visible:true,
	straightFirst: true, 
	straightLast: true, 
	strokeColor:'blue',
...
window[PMGRAPHICID].startArrow_11262 = window[PMGRAPHICID].pointc;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_11262 = window[PMGRAPHICID].board.create('point', 
	[ 
	...
	{visible:false});
window[PMGRAPHICID].arrow_11262 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_11262, window[PMGRAPHICID].endArrow_11262], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
...
window[PMGRAPHICID].startArrow_71521 = window[PMGRAPHICID].pointd;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_71521 = window[PMGRAPHICID].board.create('point', 
	[ 
	...
	{visible:false});
window[PMGRAPHICID].arrow_71521 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_71521, window[PMGRAPHICID].endArrow_71521], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
...
window[PMGRAPHICID].text84608 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ cssClass:'window[PMGRAPHICID].text84608 center', cssStyle:'' , fontSize:'18' , strokeColor:'black' } );
 /* Create Text */
window[PMGRAPHICID].text95924 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ cssClass:'window[PMGRAPHICID].text95924 center', cssStyle:'' , fontSize:'18' , strokeColor:'black' } );
  
window[PMGRAPHICID].text40167 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointc.X()+1; }, 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text40167 center', 
	  cssClass:'window[PMGRAPHICID].text40167 center', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text66465 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointc.X()+1; }, 
		function() { return window[PMGRAPHICID].pointc.Y()+-0.5; }, 
		function() { 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text66465 center', 
	  cssClass:'window[PMGRAPHICID].text66465 center', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
  
window[PMGRAPHICID].text88554 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointd.X()+1; }, 
		function() { return window[PMGRAPHICID].pointd.Y()+0.5; }, 
		function() { 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text88554 center', 
	  cssClass:'window[PMGRAPHICID].text88554 center', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text98097 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointd.X()+1; }, 
		function() { return window[PMGRAPHICID].pointd.Y()+-0.5; }, 
		function() { 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text98097 center', 
	  cssClass:'window[PMGRAPHICID].text98097 center', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
