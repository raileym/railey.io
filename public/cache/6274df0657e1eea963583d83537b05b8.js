  ...
  CTNS.QUIZ_SET["6274df0657e1eea963583d83537b05b8"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '3749', 1);
    ...
    */
	...
	jQuery(".slide_3749").each( function() {do_center(this)} );
 ...
 * quiz container.
 */
CTNS.NUMBERS.GID = 'quiz_3749';
CTNS.NUMBERS.equations['quiz_3749'] = [];
CTNS.NUMBERS.symbols['quiz_3749'] = CTNS.NUMBERS.symbols['quiz_3749'] || {};

/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_3749_SlideNo_0'] = CTNS.NUMBERS.symbols['new_scriptblock_3749_SlideNo_0'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_3749'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_3749_SlideNo_0',                ablock           = '#answerblock_3749_SlideNo_0',                acblock          = '#answercommentaryblock_3749_SlideNo_0',                                grblock          = 'graphicblock_3749_SlideNo_0',                grblock_Q        = 'graphicblock_Q_3749_SlideNo_0',                grblock_A        = 'graphicblock_A_3749_SlideNo_0',                grblock_B        = 'graphicblock_B_3749_SlideNo_0',                grblock_C        = 'graphicblock_C_3749_SlideNo_0',                grblock_D        = 'graphicblock_D_3749_SlideNo_0',                grblock_E        = 'graphicblock_E_3749_SlideNo_0',                grblock_F        = 'graphicblock_F_3749_SlideNo_0',                                grblock_f        = (typeof tml_3749_SlideNo_0   !== 'undefined') ? tml_3749_SlideNo_0   : null,                grblock_Q_f      = (typeof tml_Q_3749_SlideNo_0 !== 'undefined') ? tml_Q_3749_SlideNo_0 : null,                grblock_A_f      = (typeof tml_A_3749_SlideNo_0 !== 'undefined') ? tml_A_3749_SlideNo_0 : null,                grblock_B_f      = (typeof tml_B_3749_SlideNo_0 !== 'undefined') ? tml_B_3749_SlideNo_0 : null,                grblock_C_f      = (typeof tml_C_3749_SlideNo_0 !== 'undefined') ? tml_C_3749_SlideNo_0 : null,                grblock_D_f      = (typeof tml_D_3749_SlideNo_0 !== 'undefined') ? tml_D_3749_SlideNo_0 : null,                grblock_E_f      = (typeof tml_E_3749_SlideNo_0 !== 'undefined') ? tml_E_3749_SlideNo_0 : null,                grblock_F_f      = (typeof tml_F_3749_SlideNo_0 !== 'undefined') ? tml_F_3749_SlideNo_0 : null,                numbers          = NUMBERS,                gid              = 'quiz_3749',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_3749_SlideNo_0'],                gsymbols         = NUMBERS.symbols['quiz_3749'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];         /* See Make.php for this dummy entry. A custom script will override this entry. */             [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f,             grblock_E_f,             grblock_F_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D,             grblock_E,             grblock_F].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_3749_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_3749_SlideNo_0
	What do these buy me? tag=, masterid=3749, slideno=SlideNo_0
	'scriptblock_3749_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_3749_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_3749_SlideNo_0'] = NUMBERS.symbols['scriptblock_3749_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_3749_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_52419 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointA, window[PMGRAPHICID].pointB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'black',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_52419 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointA, window[PMGRAPHICID].pointB] , { 
	visible:true,
	straightFirst: true, 
	straightLast: true, 
	strokeColor:'black',
...
window[PMGRAPHICID].startArrow_55763 = window[PMGRAPHICID].pointA;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_55763 = window[PMGRAPHICID].board.create('point', 
	[ 
	...
	{visible:false});
window[PMGRAPHICID].arrow_55763 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_55763, window[PMGRAPHICID].endArrow_55763], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
...
window[PMGRAPHICID].startArrow_44618 = window[PMGRAPHICID].pointC;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_44618 = window[PMGRAPHICID].board.create('point', 
	[ 
	...
	{visible:false});
window[PMGRAPHICID].arrow_44618 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_44618, window[PMGRAPHICID].endArrow_44618], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
...
window[PMGRAPHICID].startArrow_52913 = window[PMGRAPHICID].pointD;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_52913 = window[PMGRAPHICID].board.create('point', 
	[ 
	...
	{visible:false});
window[PMGRAPHICID].arrow_52913 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_52913, window[PMGRAPHICID].endArrow_52913], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
...
window[PMGRAPHICID].startArrow_25524 = window[PMGRAPHICID].pointAC;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_25524 = window[PMGRAPHICID].board.create('point', 
	[ 
	...
	{visible:false});
window[PMGRAPHICID].arrow_25524 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_25524, window[PMGRAPHICID].endArrow_25524], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
...
window[PMGRAPHICID].startArrow_4163 = window[PMGRAPHICID].pointCD;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_4163 = window[PMGRAPHICID].board.create('point', 
	[ 
	...
	{visible:false});
window[PMGRAPHICID].arrow_4163 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_4163, window[PMGRAPHICID].endArrow_4163], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
...
window[PMGRAPHICID].startArrow_94998 = window[PMGRAPHICID].pointDB;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_94998 = window[PMGRAPHICID].board.create('point', 
	[ 
	...
	{visible:false});
window[PMGRAPHICID].arrow_94998 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_94998, window[PMGRAPHICID].endArrow_94998], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
	...
	arrowType: 'normal',
	strokeColor: 'black'
	});  window[PMGRAPHICID].CPoint_38696 = window[PMGRAPHICID].board.create('point', [ function() { return window[PMGRAPHICID].pointC.X();}, function() { return window[PMGRAPHICID].pointA.Y();} ], {visible:false});window[PMGRAPHICID].poly_38696   = window[PMGRAPHICID].board.create('polygon', [ window[PMGRAPHICID].pointA, window[PMGRAPHICID].pointC, window[PMGRAPHICID].CPoint_38696 ] , { fillColor:'green', withLines:false, strokeColor: '#00FFEE', fillOpacity:0.35} ); window[PMGRAPHICID].CPoint_29513 = window[PMGRAPHICID].board.create('point', [ function() { return window[PMGRAPHICID].pointD.X();}, function() { return window[PMGRAPHICID].pointC.Y();} ], {visible:false});window[PMGRAPHICID].poly_29513   = window[PMGRAPHICID].board.create('polygon', [ window[PMGRAPHICID].pointC, window[PMGRAPHICID].pointD, window[PMGRAPHICID].CPoint_29513 ] , { fillColor:'green', withLines:false, strokeColor: '#00FFEE', fillOpacity:0.35} ); window[PMGRAPHICID].CPoint_43632 = window[PMGRAPHICID].board.create('point', [ function() { return window[PMGRAPHICID].pointB.X();}, function() { return window[PMGRAPHICID].pointD.Y();} ], {visible:false});window[PMGRAPHICID].poly_43632   = window[PMGRAPHICID].board.create('polygon', [ window[PMGRAPHICID].pointD, window[PMGRAPHICID].pointB, window[PMGRAPHICID].CPoint_43632 ] , { fillColor:'green', withLines:false, strokeColor: '#00FFEE', fillOpacity:0.35} );  
...
window[PMGRAPHICID].text1636 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
	  ...
	  highlightCssClass:'window[PMGRAPHICID].text1636 ', 
	  cssClass:'window[PMGRAPHICID].text1636 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text95722 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text95722 ', 
	  cssClass:'window[PMGRAPHICID].text95722 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text37859 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text37859 ', 
	  cssClass:'window[PMGRAPHICID].text37859 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
  
window[PMGRAPHICID].text67345 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text67345 ', 
	  cssClass:'window[PMGRAPHICID].text67345 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text88800 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text88800 ', 
	  cssClass:'window[PMGRAPHICID].text88800 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text21463 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text21463 ', 
	  cssClass:'window[PMGRAPHICID].text21463 ', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
