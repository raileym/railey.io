  ...
  CTNS.QUIZ_SET["2245fdf763d2081590c1caacf107dda1"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '4645', 1);
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_4645_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_4645_SlideNo_0
	What do these buy me? tag=, masterid=4645, slideno=SlideNo_0
	'scriptblock_4645_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_4645_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_4645_SlideNo_0'] = NUMBERS.symbols['scriptblock_4645_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_4645_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_41441 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_41441 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_28422 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointbT, window[PMGRAPHICID].pointbB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_28422 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointbT, window[PMGRAPHICID].pointbB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
	...
	strokeWidth: 4} );
         ...
         */
        window[PMGRAPHICID].graph67779 = window[PMGRAPHICID].board.create('functiongraph', 
