  ...
  CTNS.QUIZ_SET["493894aafd646608105b6a7c16e856e2"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '3289', 1);
    ...
    */
	...
	jQuery(".slide_3289").each( function() {do_center(this)} );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_3289_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_3289_SlideNo_0
	What do these buy me? tag=, masterid=3289, slideno=SlideNo_0
	'scriptblock_3289_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_3289_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_3289_SlideNo_0'] = NUMBERS.symbols['scriptblock_3289_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_3289_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_17895 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointT, window[PMGRAPHICID].pointB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_17895 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointT, window[PMGRAPHICID].pointB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
...
jQuery('button#button'+PMGRAPHICID+'start').click(function(event) {
    ...
    window[PMGRAPHICID].pointz.moveTo([x,y],1000);
         ...
         */
        window[PMGRAPHICID].graph63413 = window[PMGRAPHICID].board.create('functiongraph', 
