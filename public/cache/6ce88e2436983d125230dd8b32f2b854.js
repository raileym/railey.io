  ...
  CTNS.QUIZ_SET["6ce88e2436983d125230dd8b32f2b854"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '3085', 2);
    ...
    */
	...
	jQuery(".slide_3085").each( function() {do_center(this)} );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_Q_3085_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_Q_3085_SlideNo_0
	What do these buy me? tag=Q_, masterid=3085, slideno=SlideNo_0
	'scriptblock_3085_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_Q_3085_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_3085_SlideNo_0'] = NUMBERS.symbols['scriptblock_3085_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_3085_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_39208 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointp_, window[PMGRAPHICID].pointq_] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'black',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_39208 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointp_, window[PMGRAPHICID].pointq_] , { 
	visible:true,
	straightFirst: true, 
	straightLast: true, 
	strokeColor:'black',
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_A_3085_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_A_3085_SlideNo_0
	What do these buy me? tag=A_, masterid=3085, slideno=SlideNo_0
	'scriptblock_3085_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_A_3085_SlideNo_0';
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_70420 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointp_, window[PMGRAPHICID].pointq_] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'black',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_70420 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointp_, window[PMGRAPHICID].pointq_] , { 
	visible:true,
	straightFirst: true, 
	straightLast: true, 
	strokeColor:'black',
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_Q_3085_SlideNo_1 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_Q_3085_SlideNo_1
	What do these buy me? tag=Q_, masterid=3085, slideno=SlideNo_1
	'scriptblock_3085_SlideNo_1'
	*/
	
	PMGRAPHICID   = 'graphicblock_Q_3085_SlideNo_1';
...
/*
    NUMBERS.symbols['scriptblock_3085_SlideNo_1'] = NUMBERS.symbols['scriptblock_3085_SlideNo_1'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_3085_SlideNo_1'];
*/
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_A_3085_SlideNo_1 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_A_3085_SlideNo_1
	What do these buy me? tag=A_, masterid=3085, slideno=SlideNo_1
	'scriptblock_3085_SlideNo_1'
	*/
	
	PMGRAPHICID   = 'graphicblock_A_3085_SlideNo_1';
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_93493 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointu, window[PMGRAPHICID].pointv] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'blue',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_93493 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointu, window[PMGRAPHICID].pointv] , { 
	visible:true,
	straightFirst: true, 
	straightLast: true, 
	strokeColor:'blue',
