  ...
  CTNS.QUIZ_SET["dfc3893e2648ae2b19ade7b965e6b937"] = function (PYTHON_ID) {
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_1215332797 (CTNS, NUMBERS, GID, SCRIPTBLOCK_ID, FACTORY_ID, GRAPHICBLOCK_ID) {
...
jQuery('button#button'+PMGRAPHICID+'start').click(function(event) {
    ...
    window[PMGRAPHICID].pointb.moveTo([x,y],1000);
         ...
         */
        window[PMGRAPHICID].graph8357 = window[PMGRAPHICID].board.create('functiongraph', 
...
tml_1215332797(CTNS, CTNS.NUMBERS, CTNS.NUMBERS.GID, SCRIPTBLOCK_ID, FACTORY_ID, GRAPHICBLOCK_ID);
     };