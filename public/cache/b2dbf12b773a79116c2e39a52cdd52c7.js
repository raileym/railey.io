  ...
  CTNS.QUIZ_SET["b2dbf12b773a79116c2e39a52cdd52c7"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '4644', 1);
    ...
    */
	...
	jQuery(".slide_4644").each( function() {do_center(this)} );
 ...
 * quiz container.
 */
CTNS.NUMBERS.GID = 'quiz_4644';
CTNS.NUMBERS.equations['quiz_4644'] = [];
CTNS.NUMBERS.symbols['quiz_4644'] = CTNS.NUMBERS.symbols['quiz_4644'] || {};

/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_4644_SlideNo_0'] = CTNS.NUMBERS.symbols['new_scriptblock_4644_SlideNo_0'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_4644'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_4644_SlideNo_0',                ablock           = '#answerblock_4644_SlideNo_0',                acblock          = '#answercommentaryblock_4644_SlideNo_0',                                grblock          = 'graphicblock_4644_SlideNo_0',                grblock_Q        = 'graphicblock_Q_4644_SlideNo_0',                grblock_A        = 'graphicblock_A_4644_SlideNo_0',                grblock_B        = 'graphicblock_B_4644_SlideNo_0',                grblock_C        = 'graphicblock_C_4644_SlideNo_0',                grblock_D        = 'graphicblock_D_4644_SlideNo_0',                                grblock_f        = (typeof tml_4644_SlideNo_0   !== 'undefined') ? tml_4644_SlideNo_0   : null,                grblock_Q_f      = (typeof tml_Q_4644_SlideNo_0 !== 'undefined') ? tml_Q_4644_SlideNo_0 : null,                grblock_A_f      = (typeof tml_A_4644_SlideNo_0 !== 'undefined') ? tml_A_4644_SlideNo_0 : null,                grblock_B_f      = (typeof tml_B_4644_SlideNo_0 !== 'undefined') ? tml_B_4644_SlideNo_0 : null,                grblock_C_f      = (typeof tml_C_4644_SlideNo_0 !== 'undefined') ? tml_C_4644_SlideNo_0 : null,                grblock_D_f      = (typeof tml_D_4644_SlideNo_0 !== 'undefined') ? tml_D_4644_SlideNo_0 : null,                numbers          = NUMBERS,                gid              = 'quiz_4644',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_4644_SlideNo_0'],                gsymbols         = NUMBERS.symbols['quiz_4644'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];                 do {             symbols.x1 = 0;             symbols.y1 = [0, 1, 2, 3, 4].ctns_rand();             symbols.x2 = [1, 2, 3, 4, 5].ctns_rand();             symbols.y2 = [-4, -3, -2, -1].ctns_rand();         } while( symbols.x1 == symbols.x2 || symbols.y1 == symbols.y2 || is_pos(symbols.x1) || is_neg(symbols.x2) );          symbols.m = (symbols.y2-symbols.y1)/(symbols.x2-symbols.x1);         symbols.b = symbols.y1 - symbols.x1*symbols.m;          symbols.m_ = d2f( symbols.m );         symbols.p_x1 = addparen( symbols.x1 );         symbols.p_y1 = addparen( symbols.y1 );          q.push(' Consider a line with slope-intercept form<br/><br/> $$y = ${m_}x+\\color{blue}{${b}}$$<br/><br/> that connects the two points $$p$$ and $$q$$, <br/><br/> $$ (${x1}, \\color{blue}{${y1}}) $$ and $$ (${x2}, ${y2}),$$ <br/><br/> where the <strong>$$y$$-intercept</strong> is $$\\color{blue} b = ${b}$$, and the <strong>slope</strong> is $$m = ${m_}, $$<br/><br/> $$\\frac{\\Delta y}{\\Delta x} = \\frac{y_2-y_1}{x_2-x_1} = \\frac{${y2}-${p_y1}}{${x2}-${p_x1}} = ${m_}$$. ');          $(qblock).html(tex({'symbols':symbols}, q.join(' ')));                  [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_4644_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_4644_SlideNo_0
	What do these buy me? tag=, masterid=4644, slideno=SlideNo_0
	'scriptblock_4644_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_4644_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_4644_SlideNo_0'] = NUMBERS.symbols['scriptblock_4644_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_4644_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_63554 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointp, window[PMGRAPHICID].pointq] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'blue',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_63554 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointp, window[PMGRAPHICID].pointq] , { 
	visible:true,
	straightFirst: true, 
	straightLast: true, 
	strokeColor:'blue',
...
window[PMGRAPHICID].startArrow_13175 = window[PMGRAPHICID].pointr;
/* On showarrowend ...
 */
window[PMGRAPHICID].endArrow_13175 = window[PMGRAPHICID].board.create('point', 
	[ 
	...
	{visible:false});
window[PMGRAPHICID].arrow_13175 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].startArrow_13175, window[PMGRAPHICID].endArrow_13175], {
	strokeWidth: 2,
	straightfirst:false,
	straightlast:false,
	lastArrow:true,
...
window[PMGRAPHICID].text93925 = window[PMGRAPHICID].board.create('text', 
    [ 
	...
	{ cssClass:'window[PMGRAPHICID].text93925 center', cssStyle:'' , fontSize:'18' , strokeColor:'black' } );
 
window[PMGRAPHICID].text25972 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointr.X()+1; }, 
	...
	{ anchorX:'middle', 
	  ...
	  highlightCssClass:'window[PMGRAPHICID].text25972 center', 
	  cssClass:'window[PMGRAPHICID].text25972 center', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
 
window[PMGRAPHICID].text60558 = window[PMGRAPHICID].board.create('text', 
    [ 
		function() { return window[PMGRAPHICID].pointr.X()+1; }, 
		function() { return window[PMGRAPHICID].pointr.Y()+-0.5; }, 
		function() { 
	...
	{ anchorX:'middle', 
      anchorY:'middle',
	  highlightCssStyle:'opacity:1.0', 
	  highlightCssClass:'window[PMGRAPHICID].text60558 center', 
	  cssClass:'window[PMGRAPHICID].text60558 center', 
	  cssStyle:'' , 
	  fontSize:'18' , 
	  strokeColor:'black' } );
