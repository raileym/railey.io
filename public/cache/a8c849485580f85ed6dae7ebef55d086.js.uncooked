  ...
  CTNS.QUIZ_SET["a8c849485580f85ed6dae7ebef55d086"] = function (PYTHON_ID) {
     ...
     CTNS.QUESTIONS[CTNS_ID] = [
{
    ...
    frontSpeak: " Field Axioms - Commutativity<br><br>Real Numbers $$\mathbb{R}$$     ",
    backSpeak: "  Addition and multiplication are commutative  for the set of real numbers $$\mathbb{R}$$ such that <br><br>$$x+y = y+x$$ &nbsp; and &nbsp; $$x \cdot y = y \cdot x$$<br><br>for $$x, y \in \mathbb{R}.$$     ",
