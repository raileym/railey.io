  ...
  CTNS.QUIZ_SET["d6741c6794847f014e4c03d7442ce978"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '2331', 1);
    ...
    */
	...
	jQuery(".slide_2331").each( function() {do_center(this)} );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_A_2331_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_A_2331_SlideNo_0
	What do these buy me? tag=A_, masterid=2331, slideno=SlideNo_0
	'scriptblock_2331_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_A_2331_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_2331_SlideNo_0'] = NUMBERS.symbols['scriptblock_2331_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_2331_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_47675 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointtop, window[PMGRAPHICID].pointbottom] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_47675 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointtop, window[PMGRAPHICID].pointbottom] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_B_2331_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_B_2331_SlideNo_0
	What do these buy me? tag=B_, masterid=2331, slideno=SlideNo_0
	'scriptblock_2331_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_B_2331_SlideNo_0';
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_69371 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointtop, window[PMGRAPHICID].pointbottom] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_69371 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointtop, window[PMGRAPHICID].pointbottom] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_C_2331_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_C_2331_SlideNo_0
	What do these buy me? tag=C_, masterid=2331, slideno=SlideNo_0
	'scriptblock_2331_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_C_2331_SlideNo_0';
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_77199 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointtop, window[PMGRAPHICID].pointbottom] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_77199 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointtop, window[PMGRAPHICID].pointbottom] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_D_2331_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_D_2331_SlideNo_0
	What do these buy me? tag=D_, masterid=2331, slideno=SlideNo_0
	'scriptblock_2331_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_D_2331_SlideNo_0';
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_94485 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointtop, window[PMGRAPHICID].pointbottom] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_94485 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointtop, window[PMGRAPHICID].pointbottom] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
	...
	strokeWidth: 4} );
         ...
         */
        window[PMGRAPHICID].graph57525 = window[PMGRAPHICID].board.create('functiongraph', 
