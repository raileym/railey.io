  ...
  CTNS.QUIZ_SET["a21e071a4329d5d17a6341a13cb05854"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '1678', 2);
    ...
    */
	...
	jQuery(".slide_1678").each( function() {do_center(this)} );
 ...
 * quiz container.
 */
CTNS.NUMBERS.GID = 'quiz_1678';
CTNS.NUMBERS.equations['quiz_1678'] = [];
CTNS.NUMBERS.symbols['quiz_1678'] = CTNS.NUMBERS.symbols['quiz_1678'] || {};

/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_1678_SlideNo_0'] = CTNS.NUMBERS.symbols['new_scriptblock_1678_SlideNo_0'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_1678'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_1678_SlideNo_0',                ablock           = '#answerblock_1678_SlideNo_0',                acblock          = '#answercommentaryblock_1678_SlideNo_0',                                grblock          = 'graphicblock_1678_SlideNo_0',                grblock_Q        = 'graphicblock_Q_1678_SlideNo_0',                grblock_A        = 'graphicblock_A_1678_SlideNo_0',                grblock_B        = 'graphicblock_B_1678_SlideNo_0',                grblock_C        = 'graphicblock_C_1678_SlideNo_0',                grblock_D        = 'graphicblock_D_1678_SlideNo_0',                                grblock_f        = (typeof tml_1678_SlideNo_0   !== 'undefined') ? tml_1678_SlideNo_0   : null,                grblock_Q_f      = (typeof tml_Q_1678_SlideNo_0 !== 'undefined') ? tml_Q_1678_SlideNo_0 : null,                grblock_A_f      = (typeof tml_A_1678_SlideNo_0 !== 'undefined') ? tml_A_1678_SlideNo_0 : null,                grblock_B_f      = (typeof tml_B_1678_SlideNo_0 !== 'undefined') ? tml_B_1678_SlideNo_0 : null,                grblock_C_f      = (typeof tml_C_1678_SlideNo_0 !== 'undefined') ? tml_C_1678_SlideNo_0 : null,                grblock_D_f      = (typeof tml_D_1678_SlideNo_0 !== 'undefined') ? tml_D_1678_SlideNo_0 : null,                numbers          = NUMBERS,                gid              = 'quiz_1678',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_1678_SlideNo_0'],                gsymbols         = NUMBERS.symbols['quiz_1678'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];                 symbols.m = [1, 2, 3, -1, -2, -3].ctns_rand();         symbols.x = [1, 2, 3, -1, -2, -3].ctns_rand();         symbols.y = [1, 2, 3, -1, -2, -3].ctns_rand();                  symbols.q_m = colorized.ctns_format(['transparent', symbols.m]);         symbols.q_x = colorized.ctns_format(['transparent', symbols.x]);         symbols.q_y = colorized.ctns_format(['transparent', symbols.y]);          symbols.a_m = colorized.ctns_format(['blue', symbols.m]);         symbols.a_x = colorized.ctns_format(['blue', symbols.x]);         symbols.a_y = colorized.ctns_format(['blue', symbols.y]);                  symbols.EQ = 'y - %s = %s ( x - %s )'.ctns_format([symbols.y, symbols.m, symbols.x]).ctns_equation();          symbols.q_EQ = colorized.ctns_format(['transparent', symbols.EQ]);         symbols.a_EQ = colorized.ctns_format(['blue', symbols.EQ]);          /* Build the QUESTION */         q.push(' Point-Slope Form<br/><br/> $$y - \\boxed{ ${q_y} } = \\boxed{ ${q_m} } ( x - \\boxed{ ${q_x} } )$$<br/><br/> $$ \\boxed{ ${q_EQ} } $$ <br/><br/><button class="ctns-button ctns-toggle-answer">Show Answer</button> ');               /* BTW, the answer-version is derived from the question-version. Do not          * forget to switch hint hide to hint show          */         $(qblock).html(tex({'symbols':symbols}, q.join(' ')));         $(ablock).html(tex({'symbols':symbols}, q.join(' ').replace(/q_/g,'a_')));                          [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);/*  * See citeations.php for this javascript. */CTNS.NUMBERS.symbols['scriptblock_1678_SlideNo_1'] = CTNS.NUMBERS.symbols['new_scriptblock_1678_SlideNo_1'] || {};(function($, CTNS, MATHJS) {    CTNS.NUMBERS.equations['quiz_1678'].push( (function(CTNS) {            var VALIDATE   = CTNS.VALIDATE,            PROBLEMS   = CTNS.PROBLEMS,            NUMBERS    = CTNS.NUMBERS,            TERM       = CTNS.TERM,            TABLES     = CTNS.TABLES,            TML_MATH3D = CTNS.TML_MATH3D,            tables     = CTNS.TABLES;                return function() {                    var colorized      = '\\textcolor{%s}{%s}',                        qblock           = '#questionblock_1678_SlideNo_1',                ablock           = '#answerblock_1678_SlideNo_1',                acblock          = '#answercommentaryblock_1678_SlideNo_1',                                grblock          = 'graphicblock_1678_SlideNo_1',                grblock_Q        = 'graphicblock_Q_1678_SlideNo_1',                grblock_A        = 'graphicblock_A_1678_SlideNo_1',                grblock_B        = 'graphicblock_B_1678_SlideNo_1',                grblock_C        = 'graphicblock_C_1678_SlideNo_1',                grblock_D        = 'graphicblock_D_1678_SlideNo_1',                                grblock_f        = (typeof tml_1678_SlideNo_1   !== 'undefined') ? tml_1678_SlideNo_1   : null,                grblock_Q_f      = (typeof tml_Q_1678_SlideNo_1 !== 'undefined') ? tml_Q_1678_SlideNo_1 : null,                grblock_A_f      = (typeof tml_A_1678_SlideNo_1 !== 'undefined') ? tml_A_1678_SlideNo_1 : null,                grblock_B_f      = (typeof tml_B_1678_SlideNo_1 !== 'undefined') ? tml_B_1678_SlideNo_1 : null,                grblock_C_f      = (typeof tml_C_1678_SlideNo_1 !== 'undefined') ? tml_C_1678_SlideNo_1 : null,                grblock_D_f      = (typeof tml_D_1678_SlideNo_1 !== 'undefined') ? tml_D_1678_SlideNo_1 : null,                numbers          = NUMBERS,                gid              = 'quiz_1678',                                graphic          = NUMBERS,                graphicblock     = NUMBERS.graphicblock,                graphic3dblock   = NUMBERS.graphic3dblock,                                symbols          = NUMBERS.symbols['scriptblock_1678_SlideNo_1'],                gsymbols         = NUMBERS.symbols['quiz_1678'],                 audio            = PROBLEMS.audio_onDemand,                audio_inline     = PROBLEMS.audio_inline_onDemand,                graphicblock     = NUMBERS.graphicblock,                exposeTextarea   = NUMBERS.exposeTextarea,                d2f              = NUMBERS.mk_d2f,                term             = TERM.term_updated,                is_zero          = NUMBERS.is_zero,                is_pos           = NUMBERS.is_pos,                is_neg           = NUMBERS.is_neg,                is_lt            = NUMBERS.is_lt,                is_gt            = NUMBERS.is_gt,                is_gte           = NUMBERS.is_gte,                is_lte           = NUMBERS.is_lte,                tex              = NUMBERS.mk_tex,                d2f              = NUMBERS.mk_d2f,                abs              = NUMBERS.mk_abs,                addparen         = NUMBERS.mk_addparen,                natural          = NUMBERS.natural,                imaginary        = NUMBERS.imaginary,                negative         = NUMBERS.negative,                rational         = NUMBERS.rational,                irrational       = NUMBERS.irrational,                integer          = NUMBERS.integer,                decimal          = NUMBERS.decimal,                odd              = NUMBERS.odd,                even             = NUMBERS.even,                real             = NUMBERS.real,                complex          = NUMBERS.complex,                whole            = NUMBERS.whole,                term             = TERM.term_updated,                debug            = NUMBERS.debug,                    a = [],                c = [],                q = [],                r = [],                w = [],                d = [];                 symbols.m = [1, 2, 3, -1, -2, -3].ctns_rand();         symbols.x = [1, 2, 3, -1, -2, -3].ctns_rand();         symbols.y = [1, 2, 3, -1, -2, -3].ctns_rand();                  symbols.q_m = colorized.ctns_format(['transparent', symbols.m]);         symbols.q_x = colorized.ctns_format(['transparent', symbols.x]);         symbols.q_y = colorized.ctns_format(['transparent', symbols.y]);          symbols.a_m = colorized.ctns_format(['blue', symbols.m]);         symbols.a_x = colorized.ctns_format(['blue', symbols.x]);         symbols.a_y = colorized.ctns_format(['blue', symbols.y]);                  symbols.EQ = 'y - %s = %s ( x - %s )'.ctns_format([symbols.y, symbols.m, symbols.x]).ctns_equation();          symbols.q_EQ = colorized.ctns_format(['transparent', symbols.EQ]);         symbols.a_EQ = colorized.ctns_format(['blue', symbols.EQ]);          /* Build the QUESTION */         q.push(' Given the Point-Slope Form<br/><br/> $$ ${EQ}, $$<br/><br/> draw the graph. <br/><br/><button class="ctns-button ctns-toggle-answer">Show Answer</button> ');               /* BTW, the answer-version is derived from the question-version. Do not          * forget to switch hint hide to hint show          */         $(qblock).html(tex({'symbols':symbols}, q.join(' ')));         $(ablock).html(tex({'symbols':symbols}, q.join(' ').replace(/q_/g,'a_')));                          [grblock_f,             grblock_Q_f,             grblock_A_f,             grblock_B_f,             grblock_C_f,             grblock_D_f].forEach(function(e) {                     if (null === e) {                    return;                }                                e(symbols, gsymbols, NUMBERS);                    });            [grblock,             grblock_Q,             grblock_A,             grblock_B,             grblock_C,             grblock_D].forEach(function(e) {                if (typeof window[e] !== "undefined" && typeof window[e].board !== "undefined" ) {                    window[e].board.update();                }            });        }})(CTNS));           })( jQuery, CTNS, window.math);
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_Q_1678_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_Q_1678_SlideNo_0
	What do these buy me? tag=Q_, masterid=1678, slideno=SlideNo_0
	'scriptblock_1678_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_Q_1678_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_1678_SlideNo_0'] = NUMBERS.symbols['scriptblock_1678_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_1678_SlideNo_0'];
*/
...
jQuery('button#button'+PMGRAPHICID+'start').click(function(event) {
    ...
    window[PMGRAPHICID].pointu.moveTo([x,y],1000);
         ...
         */
        window[PMGRAPHICID].graph33843 = window[PMGRAPHICID].board.create('functiongraph', 
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_A_1678_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_A_1678_SlideNo_0
	What do these buy me? tag=A_, masterid=1678, slideno=SlideNo_0
	'scriptblock_1678_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_A_1678_SlideNo_0';
...
window[PMGRAPHICID].textu = window[PMGRAPHICID].board.create('text', 
    ...
    {cssClass:'JXGlabel'}); 
        /* Generate a particular function
         */
        window[PMGRAPHICID].graph70358 = window[PMGRAPHICID].board.create('functiongraph', 
            [function(x){ return ((window[PMGRAPHICID].pointm) ? window[PMGRAPHICID].pointm.X() : 0)*(x-((window[PMGRAPHICID].pointu) ? window[PMGRAPHICID].pointu.X() : 0))+((window[PMGRAPHICID].pointu) ? window[PMGRAPHICID].pointu.Y() : 0);}, 
            -20,
            20], 
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_Q_1678_SlideNo_1 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_Q_1678_SlideNo_1
	What do these buy me? tag=Q_, masterid=1678, slideno=SlideNo_1
	'scriptblock_1678_SlideNo_1'
	*/
	
	PMGRAPHICID   = 'graphicblock_Q_1678_SlideNo_1';
...
/*
    NUMBERS.symbols['scriptblock_1678_SlideNo_1'] = NUMBERS.symbols['scriptblock_1678_SlideNo_1'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_1678_SlideNo_1'];
*/
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_A_1678_SlideNo_1 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_A_1678_SlideNo_1
	What do these buy me? tag=A_, masterid=1678, slideno=SlideNo_1
	'scriptblock_1678_SlideNo_1'
	*/
	
	PMGRAPHICID   = 'graphicblock_A_1678_SlideNo_1';
...
window[PMGRAPHICID].textu = window[PMGRAPHICID].board.create('text', 
    ...
    {cssClass:'JXGlabel'}); 
        /* Generate a particular function
         */
        window[PMGRAPHICID].graph36337 = window[PMGRAPHICID].board.create('functiongraph', 
            [function(x){ return ((window[PMGRAPHICID].pointm) ? window[PMGRAPHICID].pointm.X() : 0)*(x-((window[PMGRAPHICID].pointu) ? window[PMGRAPHICID].pointu.X() : 0))+((window[PMGRAPHICID].pointu) ? window[PMGRAPHICID].pointu.Y() : 0);}, 
            -20,
            20], 
            {strokeColor:'blue',strokeWidth:5}); 
