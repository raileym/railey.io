  ...
  CTNS.QUIZ_SET["099e6a4e3c4c2f883e3809a9d78d7753"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '3943', 1);
    ...
    */
	...
	jQuery(".slide_3943").each( function() {do_center(this)} );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_A_3943_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_A_3943_SlideNo_0
	What do these buy me? tag=A_, masterid=3943, slideno=SlideNo_0
	'scriptblock_3943_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_A_3943_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_3943_SlideNo_0'] = NUMBERS.symbols['scriptblock_3943_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_3943_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_12537 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_12537 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_97382 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointbT, window[PMGRAPHICID].pointbB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_97382 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointbT, window[PMGRAPHICID].pointbB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_61302 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointcT, window[PMGRAPHICID].pointcB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_61302 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointcT, window[PMGRAPHICID].pointcB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_B_3943_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_B_3943_SlideNo_0
	What do these buy me? tag=B_, masterid=3943, slideno=SlideNo_0
	'scriptblock_3943_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_B_3943_SlideNo_0';
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_41169 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_41169 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_87020 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointbT, window[PMGRAPHICID].pointbB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_87020 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointbT, window[PMGRAPHICID].pointbB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_61195 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointcT, window[PMGRAPHICID].pointcB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_61195 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointcT, window[PMGRAPHICID].pointcB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
	...
	strokeWidth: 4} );
         ...
         */
        window[PMGRAPHICID].graph51800 = window[PMGRAPHICID].board.create('functiongraph', 
