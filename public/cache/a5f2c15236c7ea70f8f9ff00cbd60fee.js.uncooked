  ...
  CTNS.QUIZ_SET["a5f2c15236c7ea70f8f9ff00cbd60fee"] = function (PYTHON_ID) {
     ...
     CTNS.QUESTIONS[CTNS_ID] = [
{
    ...
    sponsor: "",
    figure: "",
    key: "QF-QuadraticFormula",
    label: "Ctns\Question",
    multipleChoice: {a: "True", b: "False" },
    back: " Given a quadratic function in general form  <div class='tex ctns-center' data-expr='ax^2 + bx + c = 0,'></div>  then the solutions are <div class='tex ctns-center' data-expr='x=\\frac{-b \\pm \\sqrt{b^2-4ac}}{2a}'></div>     ",
    commentary: {a:"<scan class='ctns-right'>That answer is correct.</scan>  <!-- rightblock --><div id='rightblock_MASTERID' class='rightblock'></div> ",b:"<scan class='ctns-wrong'>That answer is incorrect.</scan>  <!-- wrongblock --><div id='wrongblock_MASTERID' class='wrongblock'></div> ",undecided:"<scan class='ctns-wrong'>No answer selected.</scan>  <!-- undecidedblock --><div id='undecidedblock_MASTERID' class='undecidedblock'></div> "},
    frontSpeak: " The Quadratic Formula     ",
    backSpeak: " The solution to the quadratic formula is the value  x equals negative b -- plus or minus the square root of b-squared minus 4--a--c -- all divided by 2--a.     ",
