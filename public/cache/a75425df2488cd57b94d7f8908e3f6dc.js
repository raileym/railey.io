  ...
  CTNS.QUIZ_SET["a75425df2488cd57b94d7f8908e3f6dc"] = function (PYTHON_ID) {
     ...
     CTNS.QUESTIONS[CTNS_ID] = [
{
    ...
    back: " A <strong>circle</strong> is the set of all  points <div class='tex' data-expr='(x,y)'></div> in a plane at a fixed distance <div class='tex' data-expr='r'></div> from a fixed point <div class='tex' data-expr='(h,k)'></div>, where <div class='tex' data-expr='r'></div> is the radius of the circle and <div class='tex' data-expr='(h,k)'></div> the center.  <div class='tex ctns-center' data-expr='(x-h)^2 +(y-k)^2 = r^2'></div>     ",
    commentary: {a:"<scan class='ctns-right'>That answer is correct.</scan>  <!-- rightblock --><div id='rightblock_MASTERID' class='rightblock'></div> ",b:"<scan class='ctns-wrong'>That answer is incorrect.</scan>  <!-- wrongblock --><div id='wrongblock_MASTERID' class='wrongblock'></div> ",undecided:"<scan class='ctns-wrong'>No answer selected.</scan>  <!-- undecidedblock --><div id='undecidedblock_MASTERID' class='undecidedblock'></div> "},
    frontSpeak: " Circle     ",
    backSpeak: " A circle is the set of all points in a plane at a fixed distance from a fixed point, where the fixed distance is the radius of the circle and the fixed point the center.     ",
