  ...
  CTNS.QUIZ_SET["c04a5dc8c1cf339712e25c93eb5be3ea"] = function (PYTHON_ID) {
     ...
     CTNS.QUESTIONS[CTNS_ID] = [
{
    ...
    frontSpeak: " Field Axioms<br><br>Multiplication Distributes<br>Over Addition     ",
    backSpeak: " Multiplication distributes over addition for a set F if <br>x times (y + z) = (x times y) + (x times z)<br><br>for values x-y-and-z in F.     ",
