  ...
  CTNS.QUIZ_SET["a12b40388064c2a5766a58e6a8c0569f"] = function (PYTHON_ID) {
     ...
     CTNS.QUESTIONS[CTNS_ID] = [
{
    ...
    frontSpeak: " Field Axioms<br><br>Addition Distributes<br>Over Multiplication     ",
    backSpeak: " Addition distributes<br>over multiplication for a set F if <br>(x + y) times z = (x times z) + (y times z)<br><br>for values x-y-and-z in F.     ",
