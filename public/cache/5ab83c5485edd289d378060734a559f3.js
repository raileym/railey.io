  ...
  CTNS.QUIZ_SET["5ab83c5485edd289d378060734a559f3"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '4428', 2);
    ...
    */
	...
	jQuery(".slide_4428").each( function() {do_center(this)} );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_4428_SlideNo_0 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_4428_SlideNo_0
	What do these buy me? tag=, masterid=4428, slideno=SlideNo_0
	'scriptblock_4428_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_4428_SlideNo_0';
...
/*
    NUMBERS.symbols['scriptblock_4428_SlideNo_0'] = NUMBERS.symbols['scriptblock_4428_SlideNo_0'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_4428_SlideNo_0'];
*/
 ...
 */
window[PMGRAPHICID].segment_67752 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_67752 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
	...
	strokeWidth: 4} );
         ...
         */
        window[PMGRAPHICID].graph83013 = window[PMGRAPHICID].board.create('functiongraph', 
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_4428_SlideNo_1 (symbols, gsymbols, NUMBERS) {
	...
	/* 
	tml_4428_SlideNo_1
	What do these buy me? tag=, masterid=4428, slideno=SlideNo_1
	'scriptblock_4428_SlideNo_1'
	*/
	
	PMGRAPHICID   = 'graphicblock_4428_SlideNo_1';
...
/*
    NUMBERS.symbols['scriptblock_4428_SlideNo_1'] = NUMBERS.symbols['scriptblock_4428_SlideNo_1'] || {};
    NUMBERS.symbols[GID] = NUMBERS.symbols[GID] || {};
    var gt = NUMBERS.symbols[GID],
        st = NUMBERS.symbols['scriptblock_4428_SlideNo_1'];
*/
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_37471 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'red',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_37471 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointaT, window[PMGRAPHICID].pointaB] , { 
	visible:false,
	straightFirst: false, 
	straightLast: false, 
	strokeColor:'red',
	...
	strokeWidth: 4} );
        ...
        /* Generate a particular function
         */
        window[PMGRAPHICID].graph19072 = window[PMGRAPHICID].board.create('functiongraph', 
            [function(x){ return 1/(x-((window[PMGRAPHICID].pointa) ? window[PMGRAPHICID].pointa.X() : 0));}, 
            -6,
            6], 
            {strokeColor:'black',strokeWidth:5});	 	  
