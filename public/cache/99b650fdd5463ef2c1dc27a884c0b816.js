  ...
  CTNS.QUIZ_SET["99b650fdd5463ef2c1dc27a884c0b816"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '3802', 1);
    ...
    */
	...
	jQuery(".slide_3802").each( function() {do_center(this)} );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_Q_3802_SlideNo_0 (CTNS, NUMBERS, GID, SCRIPTBLOCK_ID) {
	...
	/* 
	tml_Q_3802_SlideNo_0
	What do these buy me? tag=Q_, masterid=3802, slideno=SlideNo_0
	'scriptblock_3802_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_Q_3802_SlideNo_0';
...
tml_Q_3802_SlideNo_0(CTNS, CTNS.NUMBERS, CTNS.NUMBERS.GID, SCRIPTBLOCK_ID);
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_A_3802_SlideNo_0 (CTNS, NUMBERS, GID, SCRIPTBLOCK_ID) {
	...
	/* 
	tml_A_3802_SlideNo_0
	What do these buy me? tag=A_, masterid=3802, slideno=SlideNo_0
	'scriptblock_3802_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_A_3802_SlideNo_0';
...
window[PMGRAPHICID].textu = window[PMGRAPHICID].board.create('text', 
    ...
    {cssClass:'JXGlabel'}); 
         ...
         */
        window[PMGRAPHICID].graph38001 = window[PMGRAPHICID].board.create('functiongraph', 
...
/* SCRIPTBLOCK_ID is set earlier within QuestionTemplate */
tml_A_3802_SlideNo_0(CTNS, CTNS.NUMBERS, CTNS.NUMBERS.GID, SCRIPTBLOCK_ID);
     };