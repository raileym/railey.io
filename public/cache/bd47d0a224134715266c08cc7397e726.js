  ...
  CTNS.QUIZ_SET["bd47d0a224134715266c08cc7397e726"] = function (PYTHON_ID) {
  ...
  (function(CTNS, myRWU_factoryid, questions_meta, questions) {
	...
	slides = do_quiz(CTNS, questions, myRWU_factoryid, '4273', 1);
    ...
    */
	...
	jQuery(".slide_4273").each( function() {do_center(this)} );
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_Q_4273_SlideNo_0 (CTNS, NUMBERS, GID, SCRIPTBLOCK_ID) {
	...
	/* 
	tml_Q_4273_SlideNo_0
	What do these buy me? tag=Q_, masterid=4273, slideno=SlideNo_0
	'scriptblock_4273_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_Q_4273_SlideNo_0';
 ...
 */
window[PMGRAPHICID].segment_64944 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointa_, window[PMGRAPHICID].pointb_] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'black',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_64944 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointa_, window[PMGRAPHICID].pointb_] , { 
	visible:true,
	straightFirst: true, 
	straightLast: true, 
	strokeColor:'black',
...
tml_Q_4273_SlideNo_0(CTNS, CTNS.NUMBERS, CTNS.NUMBERS.GID, SCRIPTBLOCK_ID);
...
/*********************************************************************
 Build A Graph. 
*********************************************************************/
function tml_A_4273_SlideNo_0 (CTNS, NUMBERS, GID, SCRIPTBLOCK_ID) {
	...
	/* 
	tml_A_4273_SlideNo_0
	What do these buy me? tag=A_, masterid=4273, slideno=SlideNo_0
	'scriptblock_4273_SlideNo_0'
	*/
	
	PMGRAPHICID   = 'graphicblock_A_4273_SlideNo_0';
...
/* Create a basic segment
 */
window[PMGRAPHICID].segment_40394 = window[PMGRAPHICID].board.create('segment', [window[PMGRAPHICID].pointa_, window[PMGRAPHICID].pointb_] , { 
	visible: true,
	firstArrow: false,
	lastArrow: false,
	strokeColor:'blue',
...
/* Create a basic line
 */
window[PMGRAPHICID].line_40394 = window[PMGRAPHICID].board.create('line', [window[PMGRAPHICID].pointa_, window[PMGRAPHICID].pointb_] , { 
	visible:true,
	straightFirst: true, 
	straightLast: true, 
	strokeColor:'blue',
...
/* SCRIPTBLOCK_ID is set earlier within QuestionTemplate */
tml_A_4273_SlideNo_0(CTNS, CTNS.NUMBERS, CTNS.NUMBERS.GID, SCRIPTBLOCK_ID);
     };